-- --------------------------------------------------------
-- 主机:                           120.26.236.35
-- 服务器版本:                        10.1.16-MariaDB-1~jessie - mariadb.org binary distribution
...
-- Dumping data for table jeecg-boot.agent_config: ~1 rows (大约)
...
INSERT INTO `agent_config` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `ac_phone_num`, `ac_start_time`, `ac_end_time`, `ac_level`, `sys_user_code`) VALUES
	('1194623768926060546', 'admin', '2019-11-13 22:31:15', 'admin', '2019-11-17 01:29:36', 100, '2019-11-13 22:31:07', '2019-11-30 22:31:09', 99, 'jeecg');
...
INSERT INTO `cmcc_phone_num` (`id`, `phone_name`, `is_use`, `sys_user_code`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
	...
	('1194621138262781955', '13428996669', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 02:03:41', 'jeecg'),
	('1194621138262781956', '13428996670', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 02:04:12', 'jeecg'),
	('1194621138262781957', '13428996671', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 02:06:54', 'jeecg'),
	('1194621138262781958', '13428996672', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 02:07:18', 'jeecg'),
	('1194621138262781959', '13428996673', '1', 'zhagnxiao', '2019-11-13 00:00:00', 'admin', '2019-11-13 00:00:00', 'jeecg'),
	('1194621138262781960', '13428996674', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 02:07:21', 'jeecg'),
	('1194621138262781961', '13428996675', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 02:07:23', 'jeecg'),
	('1194621138262781962', '13428996676', '0', NULL, '2019-11-13 22:20:49', 'admin', NULL, NULL),
...
-- Dumping data for table jeecg-boot.sys_announcement_send: ~1 rows (大约)
...
-- Dumping data for table jeecg-boot.sys_depart: ~8 rows (大约)
...
-- Dumping data for table jeecg-boot.sys_log: 854 rows
...
-- Dumping data for table jeecg-boot.sys_role: ~4 rows (大约)
...
-- Dumping data for table jeecg-boot.sys_role_permission: ~375 rows (大约)
...
-- Dumping data for table jeecg-boot.sys_user: ~4 rows (大约)
...
INSERT INTO `sys_user` (`id`, `username`, `realname`, `password`, `salt`, `avatar`, `birthday`, `sex`, `email`, `phone`, `org_code`, `status`, `del_flag`, `activiti_sync`, `work_no`, `post`, `telephone`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	...
	('a75d45a015c44384a04449ee80dc3503', 'jeecg', 'jeecg', '3dd8371f3cf8240e', 'vDDkDzrK', 'user/20190220/e1fe9925bc315c60addea1b98eb1cb1349547719_1550656892940.jpg', NULL, 2, NULL, NULL, 'A02A01', 1, 0, 1, 'A001', '', NULL, 'admin', '2019-02-13 16:02:36', 'admin', '2019-11-16 23:21:04'),
	('e9ca23d68d884d4ebb19d07889727dae', 'admin', '管理员', 'cb362cfeefbf3d8d', 'RCGTeGiH', 'user/20190119/logo-2_1547868176839.png', '2018-12-05 00:00:00', 1, '11@qq.com', '18566666661', 'A01', 1, 0, 1, '111', '', NULL, NULL, '2038-06-21 17:54:10', 'jeecg', '2019-10-31 02:41:51'),
...
-- Dumping data for table jeecg-boot.sys_user_depart: ~6 rows (大约)
...
INSERT INTO `sys_user_depart` (`ID`, `user_id`, `dep_id`) VALUES
	...
	('1195723468370575361', 'a75d45a015c44384a04449ee80dc3503', '6d35e179cd814e3299bd588ea7daed3f'),
	('1f3a0267811327b9eca86b0cc2b956f3', 'bcbe1290783a469a83ae3bd8effe15d4', '5159cde220114246b045e574adceafe9'),
	('1185037756700635138', 'e9ca23d68d884d4ebb19d07889727dae', 'c6d7cb4deeac411cb3384b1b31278596'),
...
-- Dumping data for table jeecg-boot.sys_user_role: ~15 rows (大约)
...
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`) VALUES
	...
	('1195723466835460097', 'a75d45a015c44384a04449ee80dc3503', '1195697001221808129'),
	('1185037756495114241', 'e9ca23d68d884d4ebb19d07889727dae', 'f6817f48af4fb3af11b9e8bf182f618b'),
