...
-- Dumping database structure for jeecg-boot
CREATE DATABASE IF NOT EXISTS `jeecg-boot` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `jeecg-boot`;

-- Dumping structure for table jeecg-boot.agent_config
CREATE TABLE IF NOT EXISTS `agent_config` (
  ...
  `ac_phone_num` int(32) DEFAULT 100 COMMENT '可选号码数量',
  `ac_start_time` datetime DEFAULT NULL COMMENT '选号开始时间',
  `ac_end_time` datetime DEFAULT NULL COMMENT '选号结束时间',
  `ac_level` int(8) DEFAULT 99 COMMENT '优先级',
  `sys_user_code` varchar(64) DEFAULT NULL COMMENT '代理商',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table jeecg-boot.agent_config: ~0 rows (大约)
/*!40000 ALTER TABLE `agent_config` DISABLE KEYS */;
INSERT INTO `agent_config` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `ac_phone_num`, `ac_start_time`, `ac_end_time`, `ac_level`, `sys_user_code`) VALUES
	('1194623768926060546', 'admin', '2019-11-13 22:31:15', 'admin', '2019-11-17 01:29:36', 100, '2019-11-13 22:31:07', '2019-11-20 23:05:37', 99, 'jeecg');
/*!40000 ALTER TABLE `agent_config` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.cmcc_phone_num
CREATE TABLE IF NOT EXISTS `cmcc_phone_num` (
  `id` varchar(36) NOT NULL COMMENT '主键',
  `phone_name` varchar(50) DEFAULT NULL COMMENT '手机号',
  `is_use` varchar(10) DEFAULT NULL COMMENT '是否被选',
  `sys_user_code` varchar(50) DEFAULT NULL COMMENT '代理商',
...
-- Dumping data for table jeecg-boot.cmcc_phone_num: ~10 rows (大约)
/*!40000 ALTER TABLE `cmcc_phone_num` DISABLE KEYS */;
INSERT INTO `cmcc_phone_num` (`id`, `phone_name`, `is_use`, `sys_user_code`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
	('1194621138262781954', '13428996668', '1', 'jeecg', '2019-11-13 00:00:00', 'admin', '2019-11-13 00:00:00', 'admin'),
	('1194621138262781955', '13428996669', '1', 'jeecg', '2019-11-13 00:00:00', 'admin', '2019-11-17 23:04:51', 'jeecg'),
	('1194621138262781956', '13428996670', '1', 'jeecg', '2019-11-13 00:00:00', 'admin', '2019-11-18 01:13:41', 'jeecg'),
	('1194621138262781957', '13428996671', '0', '', '2019-11-13 00:00:00', 'admin', '2019-11-17 00:00:00', 'jeecg'),
	('1194621138262781958', '13428996672', '1', 'jeecg', '2019-11-13 00:00:00', 'admin', '2019-11-18 01:13:45', 'jeecg'),
	('1194621138262781959', '13428996673', '1', 'zhagnxiao', '2019-11-13 00:00:00', 'admin', '2019-11-13 00:00:00', 'jeecg'),
	('1194621138262781960', '13428996674', '0', '', '2019-11-13 00:00:00', 'admin', '2019-11-17 00:00:00', 'jeecg'),
	('1194621138262781961', '13428996675', '0', '', '2019-11-13 00:00:00', 'admin', '2019-11-17 00:00:00', 'jeecg'),
	('1194621138262781962', '13428996676', '1', 'jeecg', '2019-11-13 22:20:49', 'admin', '2019-11-17 23:05:27', 'jeecg'),
	('1194621138262781963', '13428996677', '1', 'jeecg', '2019-11-13 00:00:00', 'admin', '2019-11-17 02:04:04', 'jeecg');
/*!40000 ALTER TABLE `cmcc_phone_num` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.demo
...
-- Dumping data for table jeecg-boot.demo: ~22 rows (大约)
...
-- Dumping structure for table jeecg-boot.jeecg_monthly_growth_analysis
...
-- Dumping data for table jeecg-boot.jeecg_monthly_growth_analysis: ~24 rows (大约)
...
-- Dumping structure for table jeecg-boot.jeecg_order_customer
...
-- Dumping data for table jeecg-boot.jeecg_order_customer: ~65 rows (大约)
...
-- Dumping structure for table jeecg-boot.jeecg_order_main
...
-- Dumping data for table jeecg-boot.jeecg_order_main: ~18 rows (大约)
...
-- Dumping structure for table jeecg-boot.jeecg_order_ticket
...
-- Dumping data for table jeecg-boot.jeecg_order_ticket: ~53 rows (大约)
...
-- Dumping structure for table jeecg-boot.jeecg_project_nature_income
...
-- Dumping data for table jeecg-boot.jeecg_project_nature_income: ~8 rows (大约)
...
-- Dumping structure for table jeecg-boot.joa_demo
...
-- Dumping data for table jeecg-boot.joa_demo: ~0 rows (大约)
/*!40000 ALTER TABLE `joa_demo` DISABLE KEYS */;
/*!40000 ALTER TABLE `joa_demo` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.onl_cgform_button
...
-- Dumping data for table jeecg-boot.onl_cgform_button: ~2 rows (大约)
...
INSERT INTO `onl_cgform_button` (`ID`, `BUTTON_CODE`, `BUTTON_ICON`, `BUTTON_NAME`, `BUTTON_STATUS`, `BUTTON_STYLE`, `EXP`, `CGFORM_HEAD_ID`, `OPT_TYPE`, `ORDER_NUM`) VALUES
	('2944fa0b3c6dcbe2b4d1d227628de692', 'phone_select', 'check-circle', '选号', '1', 'button', NULL, '40289fdc6e651896016e651896960000', 'js', 1),
...
-- Dumping structure for table jeecg-boot.onl_cgform_enhance_java
...
-- Dumping data for table jeecg-boot.onl_cgform_enhance_java: ~0 rows (大约)
/*!40000 ALTER TABLE `onl_cgform_enhance_java` DISABLE KEYS */;
/*!40000 ALTER TABLE `onl_cgform_enhance_java` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.onl_cgform_enhance_js
CREATE TABLE IF NOT EXISTS `onl_cgform_enhance_js` (
  `ID` varchar(32) NOT NULL COMMENT '主键ID',
  `CG_JS` longtext DEFAULT NULL COMMENT 'JS增强内容',
...
-- Dumping data for table jeecg-boot.onl_cgform_enhance_js: ~5 rows (大约)
...
INSERT INTO `onl_cgform_enhance_js` (`ID`, `CG_JS`, `CG_JS_TYPE`, `CONTENT`, `CGFORM_HEAD_ID`) VALUES
	('24fbfbeacb56b5ebdb7c30880fcc61e2', 'phone_select(row){\n  let orgCode = row.$store.getters.userInfo.orgCode;\n	console.log(orgCode, row);\n}', 'list', NULL, '40289fdc6e651896016e651896960000'),
...
-- Dumping structure for table jeecg-boot.onl_cgform_enhance_sql
CREATE TABLE IF NOT EXISTS `onl_cgform_enhance_sql` (
  `ID` varchar(32) NOT NULL COMMENT '主键ID',
  `BUTTON_CODE` varchar(50) DEFAULT NULL COMMENT '按钮编码',
  `CGB_SQL` longtext DEFAULT NULL COMMENT 'SQL内容',
...
-- Dumping data for table jeecg-boot.onl_cgform_enhance_sql: ~0 rows (大约)
/*!40000 ALTER TABLE `onl_cgform_enhance_sql` DISABLE KEYS */;
/*!40000 ALTER TABLE `onl_cgform_enhance_sql` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.onl_cgform_field
...
-- Dumping data for table jeecg-boot.onl_cgform_field: ~721 rows (大约)
...
INSERT INTO `onl_cgform_field` (`id`, `cgform_head_id`, `db_field_name`, `db_field_txt`, `db_field_name_old`, `db_is_key`, `db_is_null`, `db_type`, `db_length`, `db_point_length`, `db_default_val`, `dict_field`, `dict_table`, `dict_text`, `field_show_type`, `field_href`, `field_length`, `field_valid_type`, `field_must_input`, `field_extend_json`, `field_value_rule_code`, `is_query`, `is_show_form`, `is_show_list`, `query_mode`, `main_table`, `main_field`, `order_num`, `update_by`, `update_time`, `create_time`, `create_by`) VALUES
	('00115189bc2bf6eba6910b6930ea73e4', '40289fdc6e226f29016e226f45580002', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	...
	('0148e4e8d1d3957310961f5c63bc162d', '40289f8c6e69fee8016e69fee8050000', 'name', '本次学习的名称', 'name', 0, 1, 'string', 50, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	...
	('02a095838e7a6583c7b37965bcccf681', '40289fdc6e608306016e6083061d0000', 'phone_name', '手机号', 'phone_name', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 1, 1, 1, 'single', '', '', 2, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	...
	('03122f61ef523951a812505f8e8714f8', '40289fdc6e226f29016e226f4bbe0003', 'station_number', '仪器编码', 'station_number', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('0335a3f4be06b9ce68b7d45b9e666d01', '40289fdc6e226f29016e226f387c0001', 's_scan_x', '寻点坐标X(m)', 's_scan_x', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('048a4ca0d5c0fe8eb3282caa053c7d70', '40289fdc6e226f29016e226f5fd20005', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('05f62ad8ae87651c0a38f2751e6682a6', '40289fdc6e226f29016e226f387c0001', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('0612b69f041f6b7dea9a8e417d921445', '40289fdc6e608306016e6083061d0000', 'update_time', '更新时间', 'update_time', 0, 1, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 7, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	...
	('0722263629437bb7932d364638ee6ecd', '40289fdc6e226f29016e226f4bbe0003', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 26, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('074c4924c1f3042ab76e5fa6dded313d', '4028abd16e69f54d016e69f587010001', 'mos_serial_port_id', 'serial_port表的ID', 'mos_serial_port_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('07710916755c6b92f63efd9bdd8f453d', '4028abd16e69f54d016e69f5e8d00004', 's_scan_z', '寻点坐标Z(m)', 's_scan_z', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('07c92f921379ec96613f27d917786859', '40289fdc6e226f29016e226f5fd20005', 'u_2c_tolerance', '测回间的2C较差', 'u_2c_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('084c4828d666496e61860ea6007c0709', '4028abd16e69f54d016e69f5e8d00004', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 26, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('095b7c3359e85926aaa1e29bdf31adf4', '40289fdc6e226f29016e226f387c0001', 's_alarm_threshold1', '累积变形报警阈值 - 黄(mm)', 's_alarm_threshold1', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('0963f103f96b06a4c7e24390ababc9ec', '40289fdc6e226f29016e226f387c0001', 's_type', '点类型(0：设站点、1：常规点、2：控制点（基准点）、3：公共点（转点）)', 's_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('097d422c65e21fdb6be6864e9f894dfa', '4028abd16e69f54d016e69f5ce020003', 'u_2c_s_tolerance', '测回间正倒镜斜距差较差', 'u_2c_s_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('099026e8dc307f98b3b65853b3048203', '40289fdc6e226f29016e226f5fd20005', 'u_control_points_minimum_num', '控制点最小采集数量', 'u_control_points_minimum_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 32, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('0aacbebd6dea631db63b039411b65b53', '40289fdc6e226f29016e226f5fd20005', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 25, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('0c98b4e5ff7871fb288552dbe4831d23', '313704f9a96f4b3dab1686e90dba28ea', 'sys_user_code', '代理商', NULL, 0, 1, 'string', 64, 0, '', '', '', '', 'sel_user', '', 120, NULL, '0', '', '', 1, 1, 1, 'single', '', '', 6, 'admin', '2019-11-16 23:32:47', '2019-11-13 01:05:45', 'admin'),
	...
	('0d38d85ca12b096dab648b88b8182d06', '313704f9a96f4b3dab1686e90dba28ea', 'update_by', '更新人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 4, 'admin', '2019-11-16 23:32:46', '2019-11-13 01:05:45', 'admin'),
	...
	('0ed9f67bab0a1031bbd6616c2bb0adbf', '40289fdc6e226f29016e226f5fd20005', 'id', 'id', 'id', 1, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('0f17a577348ebe2e85884b8cb1909c0e', '4028abd16e69f54d016e69f5ce020003', 'u_control_points_minimum_num', '控制点最小采集数量', 'u_control_points_minimum_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 32, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('0f8b213ead68025180e675ea854cbf58', '40289fdc6e226f29016e226f4bbe0003', 'station_code', '仪器型号', 'station_code', 0, 1, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('0fc19e3d41a1500e3cf5ee739d90eb92', '4028abd16e69f54d016e69f5ce020003', 'u_meas_per_num', '测回数', 'u_meas_per_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('110f6dcffd46f610514bc64da36814ab', '4028abd16e69f54d016e69f5e8d00004', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 24, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('1139acd1fb0f6f761de5a355848f62a0', '40289fdc6e226f29016e226f4bbe0003', 'dist_precisi_inc', '增量测距精度，单位为ppm，即 mm/公里', 'dist_precisi_inc', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('1153d9668f29cb132d4d00a3d558a491', '4028abd16e69f54d016e69f5bdb30002', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('1191c200300f62340b7a3f3f2a181e8b', '40289fdc6e226f29016e226f57270004', 'sp_data_bits', '数据位', 'sp_data_bits', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('12a19d87998a2c96504d95fe213e9207', '40289fdc6e226f29016e226f5fd20005', 'u_accepted_tolerance_check', '多测回观测容许限差', 'u_accepted_tolerance_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('132292f2448ff783ea971d7f39e75ea4', '4028abd16e69f54d016e69f5e8d00004', 's_scan_x', '寻点坐标X(m)', 's_scan_x', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('140cfe447c5751dc55ea04ba932ffb6d', '40289f8c6e69fee8016e69fee8050000', 'overview', '误差学习概要', 'overview', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	('14581ecf40ac3c436baa23599f8b4607', '4028abd16e69f54d016e69f587010001', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 24, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('14cb1dd1374ace7dd61af54fddf010c0', '40289fdc6e226f29016e226f70280007', 'update_by', '更新者', 'update_by', 0, 1, 'string', 50, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('157397b6c709c955e67b6340d1b946ec', '40289fdc6e226f29016e226f297f0000', 'company_name', '监测单位', 'company_name', 0, 1, 'string', 120, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('157f5f6fa983d61f74e41a4da443ca89', '4028abd16e69f54d016e69f587010001', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('162d304bc4fcd73db62b47d379d483fb', '40289fdc6e226f29016e226f5fd20005', 'u_public_meas_per_num', '公共点测回数', 'u_public_meas_per_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('1634d64067d17998fd3df159abaae785', '40289fdc6e226f29016e226f57270004', 'dtuid', 'DTUID', 'dtuid', 0, 1, 'string', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('16af267c567ec2ea7b50b28631e4a493', '40289fdc6e226f29016e226f5fd20005', 'u_status', '是否启用', 'u_status', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('178744185d544da540e0d89dbac4741f', '4028abd16e69f54d016e69f587010001', 'drytemperature', '温度', 'drytemperature', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('18157407aecc0a768a8768dcad027c99', '4028abd16e69f54d016e69f5ce020003', 'u_compensator_tolerance', '容许限差', 'u_compensator_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('18bf462c22692cf1bb345f4bccf7d24a', '4028abd16e69f54d016e69f587010001', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('199ca72e53f6ed383737bc98bdcf4075', '4028abd16e69f54d016e69f5bdb30002', 'id', 'id', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	('1a72f65a95ae62921d84fb5318b03b25', '4028abd16e69f54d016e69f5e8d00004', 'id', 'ID', 'id', 1, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('1ac0e72ed5bb83ea04c8f44bc7921f3d', '40289fdc6e608306016e6083061d0000', 'create_by', '创建人ID', 'create_by', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 6, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	('1b046a8ae401af72073dd3cb847b9122', '4028abd16e69f54d016e69f587010001', 'station_number', '仪器编码', 'station_number', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('1c6d206b8f92cc9c9318fcc289a88c5d', '4028abd16e69f54d016e69f54df30000', 'company_id', '所属企业', 'company_id', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('1e0875222d19474fc5b1b9f08a93232b', '40289fdc6e226f29016e226f387c0001', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 23, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('1ea2d4ee172f390a04ecacdec3236b74', '4028abd16e69f54d016e69f5e8d00004', 's_dz0', '初始变形量Z(mm)', 's_dz0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 34, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('1f04c3c407cf5f50472cd8addf4e1663', '4028abd16e69f54d016e69f5ce020003', 'u_2c_v_tolerance', '测回间竖盘指标差较差', 'u_2c_v_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('1f06529379749728643ab742bd3f2513', '40289fdc6e226f29016e226f6ac20006', 'mos_station_id', '测站', 'mos_station_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	...
	('20adf309e99c50313e31c062d5b8a9cc', '40289fdc6e226f29016e226f70280007', 'id', 'id', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('215b06bc227f9e51f01ef2a5b13036ff', '40289fdc6e226f29016e226f387c0001', 's_alarm_speed1', '变形速率报警阈值 - 黄(mm/天)', 's_alarm_speed1', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('2214613337a7ae25043f27e8ef453b27', '4028abd16e69f54d016e69f587010001', 'disable_flag', '默认0：可用，1：禁用', 'disable_flag', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 31, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('2232b8e4adf66ded57ce99d73016b755', '40289fdc6e226f29016e226f57270004', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('239b36f8c29b0b0aa3af796d994e0326', '40289fdc6e226f29016e226f57270004', 'listen_port', '更新通讯管理后废弃----------端口(端口类型为0-DTU本地端口，端口类型为1-采集中心侦听端口号)', 'listen_port', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('2492ae1a2838a1b362f498fb6f071297', '40289fdc6e226f29016e226f6ac20006', 'period', '周期号', 'period', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	('2620c1a24b66cbd15a85f2ae5bb6bb43', '40289fdc6e226f29016e226f4bbe0003', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('28015ae434657168101bc53674e9596f', '40289fdc6e226f29016e226f387c0001', 's_alarm_speed3', '变形速率报警阈值 - 红(mm/天)', 's_alarm_speed3', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('2922a5b18bbd0a428240a54c88894c02', '40289fdc6e226f29016e226f297f0000', 'pj_longitude', '经度', 'pj_longitude', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('29a400b349383c51bc5ec709c92645c2', '4028abd16e69f54d016e69f5e8d00004', 'mos_section_id', '断面', 'mos_section_id', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('2a0bbf5cf22ced0c326ae6d14e80184c', '4028abd16e69f54d016e69f587010001', 'comm_port', '更新通讯管理后将废弃---------通讯端口', 'comm_port', 0, 1, 'string', 50, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('2ae99b4975392cddf5cace1fc17ffd56', '40289fdc6e226f29016e226f387c0001', 's_x0', '初值X(m)', 's_x0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 29, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('2b94a0e6ceab08c3d7aaa815140ffe02', '40289fdc6e226f29016e226f297f0000', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('2bf27bd355f54cea8f537bbf1ff13d76', '40289fdc6e226f29016e226f5fd20005', 'u_job_plan', '作业计划(json)', 'u_job_plan', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('2ce56027301c9974feacbc1b4aa51aae', '4028abd16e69f54d016e69f587010001', 'station_code', '仪器型号', 'station_code', 0, 1, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('2e97981a2e686ca9de0679fd8cf0ff07', '40289fdc6e226f29016e226f57270004', 'comm_port_type', '通讯类型(0-串口，1-DTU)', 'comm_port_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('2ee50594485093c6a6f44ba7cb85c5a1', '4028abd16e69f54d016e69f5ce020003', 'u_meas_maximum', '最大重测次数', 'u_meas_maximum', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 31, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('2ff75e7ef0de1983aec01b0497d91967', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_status', '报警状态(0.正常，1.黄，2.橙，3.红)', 's_alarm_status', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('31ae2806ca35c9c3a5aaa8d81f787309', '4028abd16e69f54d016e69f5e8d00004', 's_priority_level', '优先级', 's_priority_level', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('32ce0d4591b882c15ea7bd5320b26d31', '40289fdc6e226f29016e226f57270004', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('32d2bd030dece486e88fd742883dcfdd', '40289fdc6e226f29016e226f6ac20006', 'start_time', '开始时间', 'start_time', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	('32e15d30534828c74e54652d70ef9369', '4028abd16e69f54d016e69f54df30000', 'pj_supervising_name', '监理单位', 'pj_supervising_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('3400631057cd1e3939147e07eaec8146', '40289fdc6e226f29016e226f57270004', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('344abeb571e9033f95ad6023f42691cd', '40289f8c6e69fee8016e69fee8050000', 'update_date', '最后更新时间', 'update_date', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	...
	('34e30ca804564eca7579353a25068bdc', '40289fdc6e226f29016e226f4bbe0003', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('373d2efeb31ff33dd00f0f66fb0ce987', '40289fdc6e226f29016e226f4bbe0003', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('37dfb4b86fdad2138488c898dea0980d', '4028abd16e69f54d016e69f5ce020003', 'u_hz_tolerance', '水平角(同一方向水平角观测值测回间较差)', 'u_hz_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('3841f5133d0bfcc74638253cb5f155e0', '40289fdc6e226f29016e226f45580002', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('38d17864734866a7891d2b4da3299c27', '4028abd16e69f54d016e69f587010001', 'comm_server_id', '更新通讯管理后将废弃---------通讯服务ID', 'comm_server_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('396010f79c48cb8a0543923fa004d33d', '40289fdc6e226f29016e226f6ac20006', 'log_url', '日志文件路径', 'log_url', 0, 0, 'string', 500, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	('39a6374967ec735196be23bd59b028b1', '4028abd16e69f54d016e69f5e8d00004', 's_prism_type', '棱镜类型', 's_prism_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('39f2d879d6122907d8239e45c468afb6', '40289fdc6e226f29016e226f57270004', 'sp_stop_bit', '停止位', 'sp_stop_bit', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('3acd9a6b3cf9d8a363dcea20cd9d0a76', '4028abd16e69f54d016e69f5e8d00004', 's_z0', '初值Z(m)', 's_z0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 31, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('3ccd63a09f714d8f8769efa00495795f', '40289fdc6e226f29016e226f387c0001', 's_z0', '初值Z(m)', 's_z0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 31, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('3cf30d4058f97de9d4cc2e89fae2ad0b', '40289fdc6e226f29016e226f387c0001', 's_dz0', '初始变形量Z(mm)', 's_dz0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 34, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('3d9ff4951da26b8abac49e7745dacf6c', '4028abd16e69f54d016e69f5ce020003', 'u_compensator_check', '补偿器是否启用', 'u_compensator_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('415234b02474dc9260dfeff5cd95e007', '40289fdc6e226f29016e226f5fd20005', 'u_compensator_check', '补偿器是否启用', 'u_compensator_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('4270683d993b76f0c7eac7f22e60583f', '40289fdc6e226f29016e226f387c0001', 's_scan_z', '寻点坐标Z(m)', 's_scan_z', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('428a56164720ef815b63901bad6aed1e', '40289fdc6e608306016e6083061d0000', 'update_by', '更新人ID', 'update_by', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 8, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	...
	('443c823f295964f2e22a20c4ff45ff01', '4028abd16e69f54d016e69f5ce020003', 'mos_project_id', '工程', 'mos_project_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('4518dbb72a96a730d5d24ebbf02d601a', '40289fdc6e226f29016e226f387c0001', 's_dy0', '初始变形量Y(mm)', 's_dy0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 33, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('471a480131e4a0753b79dd9f9136b40b', '4028abd16e69f54d016e69f5ce020003', 'u_alarm_status', '报警状态(-1.采集异常，0.正常，1.黄，2.橙，3.红)', 'u_alarm_status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 24, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('47304c03fd7f0863a48f85a4e414b00a', '4028abd16e69f54d016e69f5bdb30002', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('47c94df6649db6673ad529daf5722280', '40289fdc6e226f29016e226f5fd20005', 'u_meas_per_num', '测回数', 'u_meas_per_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('484436d2f888e2ed8c714cd69fa58080', '40289fdc6e226f29016e226f4bbe0003', 'dist_precisi_fix', '固定测距精度，单位为mm', 'dist_precisi_fix', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('4b360a4a3eaa2e591ef7bc68eeb0a8d8', '4028abd16e69f54d016e69f5e8d00004', 's_prism_hight', '棱镜高(mm)', 's_prism_hight', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('4c7fd1f672c80ac2f7fb5dac96bd5dfa', '4028abd16e69f54d016e69f54df30000', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('4c81be53780d08d57411d446395f1548', '40289fdc6e226f29016e226f387c0001', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('4e3ea87bc5b3db4ceb67747b1d656141', '4028abd16e69f54d016e69f5ce020003', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 28, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('4fd7e884d1c729608ca6dfaea97b6c2e', '40289fdc6e226f29016e226f70280007', 'proj_summary', '工程概况', 'proj_summary', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	('4ff21cad807ff884d3df412c61595f4c', '40289fdc6e226f29016e226f297f0000', 'pj_latitude', '纬度', 'pj_latitude', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('50b752a540b341b4edf0127c75fa0bd7', '4028abd16e69f54d016e69f5ce020003', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('5228049c79dfd202c598947fa0af6cdb', '40289fdc6e226f29016e226f387c0001', 's_prism_hight', '棱镜高(mm)', 's_prism_hight', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('52a8e2ddcd059ca58480bee7db58f24a', '40289fdc6e226f29016e226f297f0000', 'pj_start_working_date', '开工日期', 'pj_start_working_date', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('52ee87dab88e7f519d13a066fdab0f24', '40289fdc6e226f29016e226f70280007', 'monitoring_basis', '监测依据', 'monitoring_basis', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	('534fcd75853784b47e10f995f6c06828', '40289fdc6e226f29016e226f387c0001', 's_y0', '初值Y(m)', 's_y0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 30, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('53a772adb9ceddb2b7c8b41796579295', '4028abd16e69f54d016e69f5bdb30002', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	('5444c17884cb7683a91a3ec3c7f2c408', '40289fdc6e226f29016e226f4bbe0003', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 24, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('560ae8a58df7bfb0e27d86df3b2fa5be', '40289fdc6e226f29016e226f5fd20005', 'u_2c_v_tolerance', '测回间竖盘指标差较差', 'u_2c_v_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('565ddec834f9580d5c708f7c3b28bb53', '4028abd16e69f54d016e69f5e8d00004', 's_type', '点类型(0：设站点、1：常规点、2：控制点（基准点）、3：公共点（转点）)', 's_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('57f2d649e7554005e2a606f8496e4489', '40289fdc6e226f29016e226f5fd20005', 'u_alarm_status', '报警状态(-1.采集异常，0.正常，1.黄，2.橙，3.红)', 'u_alarm_status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 24, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('5831cf968f86d75b35c7b66d14772108', '40289fdc6e226f29016e226f70280007', 'mos_project_id', '工程ID', 'mos_project_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('58aa2f43f658312d80bde8a6b094d223', '4028abd16e69f54d016e69f5e8d00004', 's_dy0', '初始变形量Y(mm)', 's_dy0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 33, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('5910241585766d19ee3146e8ddcaeca7', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_speed2', '变形速率报警阈值 - 橙(mm/天)', 's_alarm_speed2', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('59f0d0c995df4a34c53dac2c01bf7421', '4028abd16e69f54d016e69f5ce020003', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('5a40db6348891f2a3ad404465d6e5ec5', '40289fdc6e651896016e651896960000', 'update_by', '更新人ID', 'update_by', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 8, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	...
	('5aa392830aa6b81dc238d37e86d715c0', '4028abd16e69f54d016e69f5bdb30002', 'alarm_status', '报警状态(0.正常，1.黄，2.橙，3.红)', 'alarm_status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('5b29df61d5e137160510f0c5877c262d', '4028abd16e69f54d016e69f587010001', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 25, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('5b3fa6c4e03a2b66096f0905b0d69501', '313704f9a96f4b3dab1686e90dba28ea', 'ac_start_time', '选号开始时间', NULL, 0, 1, 'Date', 32, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 1, 1, 1, 'group', '', '', 9, 'admin', '2019-11-16 23:32:47', '2019-11-13 01:05:45', 'admin'),
	('5b83a09d60e74017be5db72db9c0cc50', '40289fdc6e226f29016e226f75d80008', 'alarm_level', '级别', 'alarm_level', 0, 0, 'int', 10, 0, '', '', '', '', 'cat_tree', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 4, 'admin', '2019-10-31 23:49:52', '2019-10-31 23:29:21', 'admin'),
	('5c2b68e7db26777e73c2907a2b6e45a6', '4028abd16e69f54d016e69f54df30000', 'pj_monitoring_name', '监管单位', 'pj_monitoring_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('5ca0afcf01723f1163f217832e12ef98', '40289fdc6e226f29016e226f5fd20005', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 26, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('5cfb308093c111705179c1ac57f5f1cf', '4028abd16e69f54d016e69f5ce020003', 'u_blunder_tolerance', '粗差限差', 'u_blunder_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('5d12bc467831e083b5c0a05bd21abce9', '40289fdc6e226f29016e226f45580002', 's_direction_angle', '方向角', 's_direction_angle', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('5d3b5a1f5893458d004a7d7ac03e243a', '4028abd16e69f54d016e69f5e8d00004', 's_x0', '初值X(m)', 's_x0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 29, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('5d4c6df4f3a62a1c3a73e6cd64f0d920', '4028abd16e69f54d016e69f54df30000', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('5de5f2dc32536eaa9cc4fd071f576da1', '4028abd16e69f54d016e69f5bdb30002', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('5e3a2a059b4974146998f32c1fe2feb3', '40289fdc6e226f29016e226f5fd20005', 'u_is_double_face', '是否双面测量', 'u_is_double_face', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('5e5e3e5fc25580eae182c43dc97c6e7a', '40289fdc6e651896016e651896960000', 'sys_user_code', '代理商', 'sys_user_code', 0, 1, 'string', 50, 0, '', '', '', '', 'sel_user', '', 120, NULL, '0', '', '', 1, 1, 1, 'single', '', '', 4, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	('5ebbc689cd1f04ad989de8314f62fab1', '4028abd16e69f54d016e69f5bdb30002', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	('5f9aa1a975fcb063e438c3d2de722e93', '4028abd16e69f54d016e69f54df30000', 'pj_latitude', '纬度', 'pj_latitude', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('6115b35b8fa16e0093a320f6489e7870', '4028abd16e69f54d016e69f587010001', 'dist_precisi_fix', '固定测距精度，单位为mm', 'dist_precisi_fix', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('61835f5256ddfdf2bb33ba0ce4f8fb3f', '40289fdc6e651896016e651896960000', 'update_time', '更新时间', 'update_time', 0, 1, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 1, 0, 1, 'group', '', '', 7, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	...
	('61cf0560b039fdb27a59f12062e1bc52', '40289fdc6e608306016e6083061d0000', 'is_use', '是否被选号', 'is_use', 0, 1, 'int', 3, 0, '0', 'phone_status', '', '', 'radio', '', 120, NULL, '0', '', '', 0, 0, 1, 'group', '', '', 3, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	('61eed20df666f47b7832288ba3cd4918', '40289fdc6e651896016e651896960000', 'is_use', '是否被选', 'is_use', 0, 1, 'string', 10, 0, '', 'phone_status', '', '', 'radio', '', 120, NULL, '0', '', '', 1, 1, 1, 'single', '', '', 3, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	('61ef320e5ac3cf5a4c6787e190f5a7eb', '4028abd16e69f54d016e69f587010001', 'station_status', '0离线，表示通讯中断。1待机/关机，通讯正常，但未启动采集。2正在采集.', 'station_status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('621e2e1099cbb8fdae073d24c269f6cd', '40289fdc6e226f29016e226f5fd20005', 'u_location_check', '位置合法性检查', 'u_location_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('634b084b841113f8edaa1d1e120adae7', '4028abd16e69f54d016e69f5ce020003', 'u_accepted_tolerance_check', '多测回观测容许限差', 'u_accepted_tolerance_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('6362c846106f2b002c8a080edc729a44', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_threshold3', '累积变形报警阈值 - 红(mm)', 's_alarm_threshold3', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('6384316ba27335e31fefa312719963d5', '40289fdc6e226f29016e226f387c0001', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 25, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('639b70aa0a5308b7a963c75af5261b7f', '40289fdc6e226f29016e226f5fd20005', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 28, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('63a4503cc6be25e7a2c3e7c9129e1c09', '40289fdc6e226f29016e226f5fd20005', 'u_meas_maximum', '最大重测次数', 'u_meas_maximum', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 31, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('652e5401a306378dde83f344975a2c06', '40289fdc6e226f29016e226f297f0000', 'pj_monitoring_name', '监管单位', 'pj_monitoring_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('66839fb77a6878e8e9f4d5b742033d5e', '4028abd16e69f54d016e69f54df30000', 'pj_longitude', '经度', 'pj_longitude', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('66a839ffae82283e4c446fb318a6bee9', '4028abd16e69f54d016e69f5e8d00004', 's_azimuthal_angle', '定向边的坐标方位角', 's_azimuthal_angle', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 35, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('66d135022b4aa488204aac0bcb61e6c7', '4028abd16e69f54d016e69f587010001', 's_control_points_minimum_num', '测站内控制点最小采集数量', 's_control_points_minimum_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 29, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('675ef2b465657de840eb820be0a9d795', '313704f9a96f4b3dab1686e90dba28ea', 'update_time', '更新日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 5, 'admin', '2019-11-16 23:32:46', '2019-11-13 01:05:45', 'admin'),
	...
	('68dc2018d4cd65066567a10bbf5450dd', '40289fdc6e226f29016e226f297f0000', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('691bbaf9e15506420894f3b2a9397598', '40289fdc6e226f29016e226f387c0001', 's_scan_y', '寻点坐标Y(m)', 's_scan_y', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('69ffcf5d47dcc371cfa095bfa74ea4b8', '4028abd16e69f54d016e69f5ce020003', 'u_plane_graph', '平面图', 'u_plane_graph', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 23, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('6a652e468d433e961b85cd51109f31f1', '4028abd16e69f54d016e69f5ce020003', 'u_slope_dist_tolerance', '斜距(测回间斜距互差)', 'u_slope_dist_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('6c1b6b22e6b04a6da5b8f9ed5d651360', '40289fdc6e651896016e651896960000', 'phone_name', '手机号', 'phone_name', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 1, 1, 1, 'single', '', '', 2, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	('6c2ded405495800c5f30155712440e58', '40289fdc6e226f29016e226f75d80008', 'mos_point_id', '测点', 'mos_point_id', 0, 0, 'int', 20, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 2, 'admin', '2019-10-31 23:49:51', '2019-10-31 23:29:21', 'admin'),
	('6cc6ac92d487bcbb21625640e205162c', '40289fdc6e226f29016e226f387c0001', 's_alarm_threshold2', '累积变形报警阈值 - 橙(mm)', 's_alarm_threshold2', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('6dc8fbf086281d27a646bdbc1355f157', '40289fdc6e226f29016e226f5fd20005', 'u_v_tolerance', '垂直角(同一方向竖直角观测值测回间较差)', 'u_v_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('6ddf600e71b528192fb812348db612af', '40289fdc6e226f29016e226f57270004', 'dtu_address', '更新通讯管理后废弃--------DTU地址IP或域名，串口IP', 'dtu_address', 0, 1, 'string', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('70ada1a2e34a689ed4836430b5abb102', '40289fdc6e226f29016e226f5fd20005', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('70ebd769371000491abb5449491823c5', '40289fdc6e226f29016e226f57270004', 'sp_odd_even_check', '奇偶校验', 'sp_odd_even_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('715eb568cd4b70889537963e21dc216e', '40289fdc6e226f29016e226f387c0001', 'id', 'ID', 'id', 1, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('71de667d728d68cde7c627203c742d1d', '40289fdc6e226f29016e226f297f0000', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('725c82fbc6f8bbd7c0a72e25db11511f', '40289fdc6e226f29016e226f4bbe0003', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 27, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('72aff6a9ec86e668f1f344fff5d0953a', '40289fdc6e226f29016e226f387c0001', 'mos_section_id', '断面', 'mos_section_id', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('737ddad2bf631400a6c3d81b153c5fb2', '4028abd16e69f54d016e69f5ce020003', 'u_job_plan', '作业计划(json)', 'u_job_plan', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('73d47244ab50ebad638e2566ce2ef7e0', '4028abd16e69f54d016e69f587010001', 'angle_precisi', '测角精度，单位为秒', 'angle_precisi', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('73e87885795d0f94dc0c70694af2f296', '40289fdc6e226f29016e226f387c0001', 's_alarm_threshold3', '累积变形报警阈值 - 红(mm)', 's_alarm_threshold3', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('7428102dcab38fdc324977000b5351d8', '40289fdc6e226f29016e226f45580002', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	...
	('75a405d448f02e82a92dd8ee4dfe60e4', '40289fdc6e226f29016e226f45580002', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	...
	('76bb80c39de4fdeb7864ec33c35094c4', '4028abd16e69f54d016e69f5ce020003', 'id', 'id', 'id', 1, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('77ffdef01831611c4f53de3fb8104dd0', '4028abd16e69f54d016e69f5e8d00004', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 25, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('7838c5fe9f55f4fe13989bc4d7ea7c4e', '4028abd16e69f54d016e69f5e8d00004', 's_y0', '初值Y(m)', 's_y0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 30, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('79b0f58fcc918e59514a4808cf75dc77', '4028abd16e69f54d016e69f54df30000', 'id', 'ID', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-11-14 20:48:37', 'admin'),
	('79f778c060b266cc421fc4644fd5022c', '4028abd16e69f54d016e69f587010001', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 26, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('7a719e1b4f850444967c57b924d5753c', '40289fdc6e651896016e651896960000', 'create_by', '创建人ID', 'create_by', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 6, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	('7afe39d3dd4376fa10f1858e4bc47b71', '313704f9a96f4b3dab1686e90dba28ea', 'ac_phone_num', '可选号码数量', NULL, 0, 1, 'int', 32, 0, '100', '', '', '', 'text', '', 120, NULL, '0', '', '', 1, 1, 1, 'single', '', '', 8, 'admin', '2019-11-16 23:32:47', '2019-11-13 01:05:45', 'admin'),
	...
	('7dfb364fac0f5878a2abd6628ee7b3c2', '40289f8c6e69fee8016e69fee8050000', 'body', '误差学习内容', 'body', 0, 1, 'Text', 16777215, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	...
	('7f888b32e875555e3283a153216da18f', '40289fdc6e226f29016e226f297f0000', 'pj_supervising_name', '监理单位', 'pj_supervising_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('7ffa8f60d712d49da347cca034979cb2', '40289f8c6e69fee8016e69fee8050000', 'active_period', '生效的周期，既<active_period的周期不生效', 'active_period', 0, 0, 'int', 19, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	('80aca927432168e46502ec879e26a9a7', '40289fdc6e226f29016e226f45580002', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('81ebd775ea38f149ad86d5446892177b', '40289fdc6e226f29016e226f297f0000', 'pj_info', '工程简介', 'pj_info', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('81f752d29d692ee7948d99b738195c39', '4028abd16e69f54d016e69f587010001', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 23, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('83b98e1f1f163bd3fefa0c46944c30e6', '4028abd16e69f54d016e69f5e8d00004', 's_scan_y', '寻点坐标Y(m)', 's_scan_y', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('864e67af3a49efb4069262c5257dda21', '40289fdc6e226f29016e226f57270004', 'sp_flow_control', '流控制', 'sp_flow_control', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('867154cce7c120e40641d353b26a8fee', '40289fdc6e226f29016e226f5fd20005', 'u_compensator_tolerance', '容许限差', 'u_compensator_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('87821e21ea5cdc1a44e3d2c14100eda2', '4028abd16e69f54d016e69f5ce020003', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 26, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('88cfbc08a2a00d3b15a3762cdd65b17a', '40289fdc6e226f29016e226f4bbe0003', 'comm_server_id', '更新通讯管理后将废弃---------通讯服务ID', 'comm_server_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('895640476e05aec78ba461ff48140e2c', '40289fdc6e226f29016e226f5fd20005', 'u_blunder_tolerance', '粗差限差', 'u_blunder_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('89ae6a8752b1ea97d520de381dc755f4', '4028abd16e69f54d016e69f587010001', 's_public_points_minimum_num', '公共点最小采集数量', 's_public_points_minimum_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 30, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('89b442cce7b5ef12b0678e022288fef0', '40289fdc6e226f29016e226f57270004', 'sp_baud_rate', '波特率', 'sp_baud_rate', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('89bf13df3a819530cf2257aca209aaa4', '40289fdc6e226f29016e226f387c0001', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 26, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('8b57e23c6438d945d4838a5e2d4ce9af', '40289fdc6e226f29016e226f387c0001', 's_alarm_status', '报警状态(0.正常，1.黄，2.橙，3.红)', 's_alarm_status', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('8bac9c9ca14cf5eabdc696be27a9692a', '40289fdc6e226f29016e226f297f0000', 'pj_constructing_name', '建设单位', 'pj_constructing_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('8be577e4f5d3d9fe4ea815497a4db5ed', '4028abd16e69f54d016e69f54df30000', 'pj_start_working_date', '开工日期', 'pj_start_working_date', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('8c763df7918d915dca961151b3c7fc6e', '40289fdc6e226f29016e226f297f0000', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('8d1a755caddffca6fd465f7f76d08685', '40289f8c6e69fee8016e69fee8050000', 'last_period', '数据的最后一个周期', 'last_period', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	('8d8bf8c4d930596e12c621727c036574', '4028abd16e69f54d016e69f587010001', 'station_type', '仪器类型, 1 莱卡 2 索佳 3 天宝', 'station_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('8fba5a23eaf2519bc12fcd9d8e64aeca', '40289fdc6e226f29016e226f5fd20005', 'mos_project_id', '工程', 'mos_project_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('906b811d03c81b0d278414fa636d542b', '40289fdc6e226f29016e226f4bbe0003', 'mos_point_id', '设站点', 'mos_point_id', 0, 0, 'int', 19, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('90e75fc860d3d294bd391f4eb25d7561', '4028abd16e69f54d016e69f54df30000', 'company_name', '监测单位', 'company_name', 0, 1, 'string', 120, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('90f6a753161741c345dee164d62c0698', '4028abd16e69f54d016e69f587010001', 'station_test_info', '测站测试结果对象', 'station_test_info', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 28, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('914e17345a72aface30779d6acadad2e', '40289fdc6e226f29016e226f297f0000', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('917bba53d9510c507da0fd5a9ae17641', '40289fdc6e226f29016e226f4bbe0003', 'station_type', '仪器类型, 1 莱卡 2 索佳 3 天宝', 'station_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('923676fd87adb9a656143eef61e2891a', '40289fdc6e226f29016e226f5fd20005', 'u_2c_s_tolerance', '测回间正倒镜斜距差较差', 'u_2c_s_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 15, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('94ad97842023d0d20714af8d51670679', '4028abd16e69f54d016e69f5ce020003', 'u_status', '是否启用', 'u_status', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('9529cf554f244a13af134cff3d8c7a2b', '40289fdc6e226f29016e226f6ac20006', 'mode', '操作方式(0:自动，1:手动)', 'mode', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	('95309934f93fb56abb10e0f6c4d560a0', '4028abd16e69f54d016e69f5e8d00004', 's_dx0', '初始变形量X(mm)', 's_dx0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 32, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('95a46a22afd9c133913036623cbfecb4', '40289fdc6e226f29016e226f387c0001', 's_prism_type', '棱镜类型', 's_prism_type', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('9600822f825d8e4b2756316c280d77a5', '40289fdc6e226f29016e226f45580002', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('96076d33c5ff10be986698f0febe860d', '40289fdc6e226f29016e226f297f0000', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('9770ac32c3b44da95153bbc5361de43f', '4028abd16e69f54d016e69f5e8d00004', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('9793793b92a77bb66b4bc0236a947803', '4028abd16e69f54d016e69f54df30000', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('97c9d8e0cf10ca36526b2003c97100e8', '4028abd16e69f54d016e69f5e8d00004', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 23, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('985bf1642a01f693d2b6e1d279d152eb', '4028abd16e69f54d016e69f54df30000', 'pj_address', '地址', 'pj_address', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('98f6c4565c4a59e9d98e025798bd2916', '40289fdc6e226f29016e226f57270004', 'dtu_listen_port', 'DTU本地端口号，通讯类型为0串口时才填写', 'dtu_listen_port', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('9969ba1042a4c539c0baae1d371a2759', '40289fdc6e226f29016e226f45580002', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('99b06f0da91a44c3bf340f2e3948ff2e', '40289fdc6e226f29016e226f5fd20005', 'u_slope_dist_tolerance', '斜距(测回间斜距互差)', 'u_slope_dist_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('99cc4749d68ba2d4193390216d41ab01', '40289fdc6e226f29016e226f6ac20006', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 19, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	...
	('9a59b48ff2956bf4bf612d28ff20e5f8', '40289fdc6e608306016e6083061d0000', 'use_by', '被选号代理商', 'use_by', 0, 1, 'int', 10, 0, '', '', '', '', 'sel_depart', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 4, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	('9bc1b2c03fedc49debf6783ccd746b8e', '40289fdc6e226f29016e226f387c0001', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 27, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('9be28e04e076d1197c724327d3d9250e', '4028abd16e69f54d016e69f587010001', 'id', 'ID', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('9c3ddd2dab1d8824b11cb08412ddfcf9', '40289fdc6e226f29016e226f4bbe0003', 'station_test_info', '测站测试结果对象', 'station_test_info', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 28, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('9c59fd04c3a9dad589cc23ad61dc0c0e', '40289fdc6e226f29016e226f387c0001', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 24, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('9d68825981cac11f4bf4b82392465567', '40289fdc6e226f29016e226f75d80008', 'alarm_time', '报警时间', 'alarm_time', 0, 0, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 1, 'admin', '2019-10-31 23:49:50', '2019-10-31 23:29:21', 'admin'),
	...
	('a3e158609bc3c10314574c2deb7d276a', '4028abd16e69f54d016e69f54df30000', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('a4a754d181aa0645f71a378b6f8c8d68', '40289fdc6e226f29016e226f57270004', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('a5e6d74d1e66aab545e57a4d4852d629', '40289fdc6e226f29016e226f70280007', 'update_date', '更新时间', 'update_date', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('a7cc3c8d0659c469a002fbfe2708f89e', '4028abd16e69f54d016e69f5ce020003', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('a7d4100898b1afceadbe2911eff9f027', '40289fdc6e226f29016e226f4bbe0003', 'wettemperature', '湿度', 'wettemperature', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('a87841a1828c1b89e72796a87bdf952a', '40289fdc6e226f29016e226f5fd20005', 'u_hz_tolerance', '水平角(同一方向水平角观测值测回间较差)', 'u_hz_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('a9047974dce0ba4b8365d275f5a50689', '40289fdc6e226f29016e226f387c0001', 's_prism_additive_const', '棱镜加常数(mm)', 's_prism_additive_const', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('aa8399ba90f81d59891b1c37bdc3c364', '40289fdc6e226f29016e226f57270004', 'comm_server_id', '通讯服务ID', 'comm_server_id', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('aa89dc527c6e21e54b99e890f5aecf55', '4028abd16e69f54d016e69f5ce020003', 'u_public_meas_per_num', '公共点测回数', 'u_public_meas_per_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('ab685f0ac8e959f0cd9aefe33f4fccc9', '40289fdc6e226f29016e226f4bbe0003', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('abaefe520b59de993966b2ae7aba491c', '40289fdc6e226f29016e226f297f0000', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('abe8d7b1650721906757e70ebe7b00ec', '40289fdc6e226f29016e226f297f0000', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('ac6296804df86d06a27e817d6a51b590', '40289fdc6e226f29016e226f387c0001', 's_dx0', '初始变形量X(mm)', 's_dx0', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 32, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('acac66790cd806974b43dffe66254277', '313704f9a96f4b3dab1686e90dba28ea', 'id', '主键', NULL, 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 1, 'admin', '2019-11-16 23:32:46', '2019-11-13 01:05:45', 'admin'),
	...
	('ad2b7f29900f6a27f05036e788c3d76c', '40289fdc6e226f29016e226f297f0000', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('ad52dd34d2862823355bb1a796969047', '40289fdc6e226f29016e226f4bbe0003', 'comm_port', '更新通讯管理后将废弃---------通讯端口', 'comm_port', 0, 1, 'string', 50, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('ad595d6f961ac38c83eba4201cd76b71', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_speed3', '变形速率报警阈值 - 红(mm/天)', 's_alarm_speed3', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('ad5fb29bf1d3958c6b33a659989dc838', '4028abd16e69f54d016e69f5ce020003', 'u_v_tolerance', '垂直角(同一方向竖直角观测值测回间较差)', 'u_v_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('ae3ca4acf1a7ed015ca259a97dd3ccd2', '4028abd16e69f54d016e69f5bdb30002', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('ae7843d108e3260ca63d72a82c4e056f', '4028abd16e69f54d016e69f54df30000', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('ae7e509e1a32c2dbdc7c0641dcd55226', '40289fdc6e226f29016e226f297f0000', 'pj_work_name', '施工单位', 'pj_work_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('aee4fe447541876de0063b16744802c8', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_threshold1', '累积变形报警阈值 - 黄(mm)', 's_alarm_threshold1', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('af2308de328cf29fa0f34b21ad59da3d', '4028abd16e69f54d016e69f5e8d00004', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 28, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('b180bb0a6a7f16b8093e98a731cc9cdd', '40289fdc6e226f29016e226f45580002', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	...
	('b44d5e0ca1fa2ab95dcbb0a300393464', '40289fdc6e226f29016e226f57270004', 'name', '名称(通讯类型为0串口时才填写)', 'name', 0, 1, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('b507f523bb5914a3c502a857b3770aef', '40289fdc6e226f29016e226f5fd20005', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 29, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('b515b0ffd9c76e5b5ea3480ff07c0579', '40289fdc6e226f29016e226f5fd20005', 'u_plane_point', '平面图上点的数据', 'u_plane_point', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('b5cc7e18750a27473eedb7cbfd8822e9', '40289fdc6e226f29016e226f70280007', 'create_date', '创建时间', 'create_date', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('b60fbd12b0c2940cd9b845b593e70bb2', '40289fdc6e226f29016e226f5fd20005', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 30, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('b88099374bd04beb60c7cc6b7cd47ae6', '40289fdc6e226f29016e226f45580002', 'alarm_status', '报警状态(0.正常，1.黄，2.橙，3.红)', 'alarm_status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('b88fa7653e456a4db5820d3a150b42ae', '4028abd16e69f54d016e69f5ce020003', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 27, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('ba212d9bd56abf59b8131b8525cc1035', '40289fdc6e226f29016e226f4bbe0003', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 25, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('bbe09fb7cd05b04fe5ec99c0a1412fa0', '40289fdc6e226f29016e226f297f0000', 'company_id', '所属企业', 'company_id', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	('bc645ed2fc50617e2a0f038d95e51cda', '4028abd16e69f54d016e69f54df30000', 'update_date', '更新时间', 'update_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('bcbf35bc93d996afcfae25cf5d3af10f', '4028abd16e69f54d016e69f5ce020003', 'u_plane_point', '平面图上点的数据', 'u_plane_point', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 22, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('be34eea6f6f869b2fbd2c05a1f50813c', '40289fdc6e226f29016e226f4bbe0003', 'drytemperature', '温度', 'drytemperature', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('c3526d65d29c6ab000e0309bb3105a28', '40289fdc6e226f29016e226f387c0001', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 28, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('c3f162d5b3f75bd91c0f64b600d52f5f', '40289fdc6e226f29016e226f75d80008', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 3, 'admin', '2019-10-31 23:49:51', '2019-10-31 23:29:21', 'admin'),
	('c41ef270826de6d88df7c69bf2e2077e', '40289fdc6e226f29016e226f4bbe0003', 's_public_points_minimum_num', '公共点最小采集数量', 's_public_points_minimum_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 30, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('c492d7ece473f64b778fcb2c7a792239', '4028abd16e69f54d016e69f5e8d00004', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('c4b4e6fc3e5034e0243bb8619f875dd5', '40289fdc6e608306016e6083061d0000', 'id', 'ID号', 'id', 1, 0, 'int', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 1, 'admin', '2019-11-13 22:02:27', '2019-11-13 00:47:11', 'admin'),
	...
	('c60b96ff642700849a4e2e3e11aa5650', '40289f8c6e69fee8016e69fee8050000', 'id', '唯一ID', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-11-14 20:59:04', 'admin'),
	...
	('c6b7b7ca3263d6d71691d46a815e0f16', '40289f8c6e69fee8016e69fee8050000', 'desc', '描述性文字', 'desc', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	('c72e5d2d76401c83e90be63f656d0734', '40289fdc6e226f29016e226f387c0001', 's_priority_level', '优先级', 's_priority_level', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('c942aa8646a6892681a75b9966f8b03d', '4028abd16e69f54d016e69f5ce020003', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 25, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('ca38698c3c4ae1805002256b0356bfce', '40289fdc6e226f29016e226f387c0001', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('cbf92403251005aba32ab368213c61e4', '4028abd16e69f54d016e69f54df30000', 'pj_status', '状态(0-监测中;-2-未开始;-3-已结束;-4暂停；-1，1，2，3状态值经统计得来)', 'pj_status', 0, 1, 'int', 3, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('cc06f4e3da8a433a05f602631c25fb6b', '4028abd16e69f54d016e69f5bdb30002', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('ccfa67871bed745e995ba6992666c07b', '4028abd16e69f54d016e69f5ce020003', 'u_2c_tolerance', '测回间的2C较差', 'u_2c_tolerance', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('cd005d898991479e8cf0d07b2bee7352', '40289fdc6e226f29016e226f45580002', 'id', 'id', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('cd29dc2beb3c0d6db19fbcaf96bb8999', '4028abd16e69f54d016e69f587010001', 'pressure', '大气参数，气压', 'pressure', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('cf9313691c4079d737586ecec8d74bd0', '40289fdc6e226f29016e226f4bbe0003', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('cfc2e979132ca0dd8662b6cbbcf8d821', '40289fdc6e226f29016e226f5fd20005', 'u_plane_graph', '平面图', 'u_plane_graph', 0, 1, 'Text', 65535, 0, NULL, NULL, NULL, NULL, 'textarea', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 23, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	('cfcf8a6216264403f9e5f6673b914509', '4028abd16e69f54d016e69f5bdb30002', 's_direction_angle', '方向角', 's_direction_angle', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('d0ba62d53c58e482cd2a5772dad524c5', '40289fdc6e226f29016e226f57270004', 'dtu_psw', 'DTU密码(通讯类型为1才有效)', 'dtu_psw', 0, 1, 'string', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('d170df4337a7279b83112d3c5cb95148', '40289fdc6e226f29016e226f45580002', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('d1eaef2a729eda42c5ee0d31f0823423', '4028abd16e69f54d016e69f587010001', 'dist_precisi_inc', '增量测距精度，单位为ppm，即 mm/公里', 'dist_precisi_inc', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('d293f9f0af23f90c90dfe3d7fc16e7ac', '4028abd16e69f54d016e69f587010001', 'mos_point_id', '设站点', 'mos_point_id', 0, 0, 'int', 19, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('d2b23ad0f45f6b5cb583ce19bdf9d0df', '4028abd16e69f54d016e69f587010001', 'wettemperature', '湿度', 'wettemperature', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('d2ed73e4dd1be00c8694c2207d76158f', '4028abd16e69f54d016e69f5e8d00004', 's_prism_additive_const', '棱镜加常数(mm)', 's_prism_additive_const', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('d3afdd87f52afefe34124484540bebc5', '4028abd16e69f54d016e69f5e8d00004', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('d55913dadc3ae962ef717ff77952fea5', '40289fdc6e226f29016e226f6ac20006', 'end_time', '结束时间', 'end_time', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	...
	('d6b0ca6f140d5945183b83ccf5629e0e', '4028abd16e69f54d016e69f587010001', 'parent_ids', '父级编号列表', 'parent_ids', 0, 1, 'string', 2000, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('d75680f18459dbafd8630d480ff48abb', '40289f8c6e69fee8016e69fee8050000', 'mos_unit_id', '监测单元ID', 'mos_unit_id', 0, 0, 'int', 19, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	...
	('d8384b9fc890b282be5f39a7cf7b1aad', '4028abd16e69f54d016e69f5e8d00004', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 27, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('d884a259f01ac10dee32750a65a13823', '40289fdc6e226f29016e226f70280007', 'report_material', '监测点位布置图json表示，如：{"report_images":[{"image":"数据目录/项目ID/断面监测点布置图.jpg"},{"image":"数据目录/项目ID/断面隧道布置图.jpg"}]}', 'report_material', 0, 1, 'string', 500, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('d990abbcb28df359601eb8a97934840d', '4028abd16e69f54d016e69f5e8d00004', 's_measure_model', '测量模式', 's_measure_model', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('da22be8e6924c29ac0acb67f74de7551', '40289fdc6e226f29016e226f4bbe0003', 'turnon_lasttime', '上次开机时间', 'turnon_lasttime', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('da38868ccb0ed6b7e5dbd6533342084a', '313704f9a96f4b3dab1686e90dba28ea', 'create_by', '创建人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 2, 'admin', '2019-11-16 23:32:46', '2019-11-13 01:05:45', 'admin'),
	('da619d747979d04a61e64acec7118e38', '40289fdc6e226f29016e226f57270004', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 18, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('daa678aab3bc0cdbdab50131fcbb70f6', '313704f9a96f4b3dab1686e90dba28ea', 'ac_end_time', '选号结束时间', NULL, 0, 1, 'Date', 32, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 1, 1, 1, 'group', '', '', 10, 'admin', '2019-11-16 23:32:47', '2019-11-13 01:05:45', 'admin'),
	...
	('db1fbf0d08db683c182a1b4dce36ecc4', '4028abd16e69f54d016e69f54df30000', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('dbebd40a86adbc11ba22386d5c7045d7', '4028abd16e69f54d016e69f54df30000', 'pj_work_name', '施工单位', 'pj_work_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 11, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	('dc3c8ad858d3bacae06243ecee1bafba', '4028abd16e69f54d016e69f5ce020003', 'u_is_double_face', '是否双面测量', 'u_is_double_face', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('dd04384d2fb99b67f36825d8dce153e1', '40289fdc6e226f29016e226f4bbe0003', 'angle_precisi', '测角精度，单位为秒', 'angle_precisi', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('ddb3368645060d38aeadeabfb44ab864', '313704f9a96f4b3dab1686e90dba28ea', 'ac_level', '优先级', NULL, 0, 1, 'int', 8, 0, '99', '', '', '', 'text', '', 120, NULL, '0', '', '', 1, 1, 1, 'group', '', '', 7, 'admin', '2019-11-16 23:32:47', '2019-11-13 01:05:45', 'admin'),
	...
	('ddd3ebafac114bc39c40105b0d3de668', '4028abd16e69f54d016e69f5bdb30002', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	('de8da90e3e7ea6edfef6b64697deab48', '4028abd16e69f54d016e69f5bdb30002', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 2, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	('de9cd930ca0008656ae3340c43fa9a69', '40289fdc6e226f29016e226f70280007', 'create_by', '创建者', 'create_by', 0, 1, 'string', 50, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('df2850dfe3f6a260611963a25d290139', '4028abd16e69f54d016e69f5ce020003', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 29, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	...
	('df5684a11845611dde0b92ce0cccf890', '40289fdc6e226f29016e226f387c0001', 'mos_unit_id', '监测单元', 'mos_unit_id', 0, 0, 'int', 20, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('e0a2fee6fd786a286e946f1a622eda20', '4028abd16e69f54d016e69f587010001', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 7, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('e149558b6d65d2ff2ad81c03ae6fc5e1', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_threshold2', '累积变形报警阈值 - 橙(mm)', 's_alarm_threshold2', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('e3a3bc9e4baceb3b2c5a0315c5e6d262', '40289fdc6e226f29016e226f4bbe0003', 'disable_flag', '默认0：可用，1：禁用', 'disable_flag', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 31, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('e65e32f706dd3b5f2c51f8b0a61c271d', '4028abd16e69f54d016e69f54df30000', 'pj_constructing_name', '建设单位', 'pj_constructing_name', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 9, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('e7776b5b6136d97fdccd71db09f6557a', '40289fdc6e226f29016e226f5fd20005', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 27, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('e804a8c6c089dbb8bc31305460a71076', '4028abd16e69f54d016e69f5e8d00004', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	...
	('e86af54df4525b131e0a00252a4dd786', '40289fdc6e226f29016e226f70280007', 'del_flag', 'delFlag', 'del_flag', 0, 1, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:19', 'admin'),
	...
	('e97adce679a1aa3e28117e4315c1f8fb', '40289fdc6e226f29016e226f4bbe0003', 's_control_points_minimum_num', '测站内控制点最小采集数量', 's_control_points_minimum_num', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 29, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('e9d4ca9ca6b07e814b3476a41d6ea35c', '4028abd16e69f54d016e69f587010001', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 27, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('eb4800eff9734839627082d6df3b81a5', '40289fdc6e226f29016e226f57270004', 'company_id', '公司ID', 'company_id', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 5, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('ec0ee6bcbfa8ce5fa74e223f4fc086bf', '40289fdc6e226f29016e226f297f0000', 'pj_address', '地址', 'pj_address', 0, 1, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('ed032cc21aa4af74ecdc4aa29695f032', '40289fdc6e226f29016e226f4bbe0003', 'mos_serial_port_id', 'serial_port表的ID', 'mos_serial_port_id', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('ed6972ea69293b2ab0ff705165af7c40', '40289fdc6e651896016e651896960000', 'id', '主键', 'id', 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 1, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:01', 'admin'),
	('eda0a8234e4077ebf049e04a28ff3c84', '40289fdc6e226f29016e226f387c0001', 's_alarm_speed2', '变形速率报警阈值 - 橙(mm/天)', 's_alarm_speed2', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('edae52c2bba83e1ef9c79655db9d2b38', '4028abd16e69f54d016e69f54df30000', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 19, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('eef4b677d9e95aa5559615af79f9c1db', '4028abd16e69f54d016e69f5ce020003', 'u_location_check', '位置合法性检查', 'u_location_check', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-11-14 20:49:10', 'admin'),
	('ef272619123be9c4314357f0b7fb696e', '40289fdc6e226f29016e226f75d80008', 'alarm_desc', '描述', 'alarm_desc', 0, 1, 'string', 200, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 5, 'admin', '2019-10-31 23:49:52', '2019-10-31 23:29:21', 'admin'),
	('ef700a82c82e158ca6c445e057437758', '4028abd16e69f54d016e69f5bdb30002', 'name', '名称', 'name', 0, 0, 'string', 128, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 3, NULL, NULL, '2019-11-14 20:49:04', 'admin'),
	...
	('ef9102598768599b24a268ae14a85a4d', '40289fdc6e651896016e651896960000', 'create_time', '创建时间', 'create_time', 0, 1, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 5, 'admin', '2019-11-16 23:31:23', '2019-11-13 22:09:02', 'admin'),
	('efca37b693e27ef88d5c315f6c5d3fa2', '40289fdc6e226f29016e226f297f0000', 'pj_status', '状态(0-监测中;-2-未开始;-3-已结束;-4暂停；-1，1，2，3状态值经统计得来)', 'pj_status', 0, 1, 'int', 3, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-10-31 23:29:03', 'admin'),
	...
	('f028e339d4c76657c8bbf05f20141a70', '40289fdc6e226f29016e226f6ac20006', 'status', '采集状态(0:未开始，1:正在采集，2:成功，3:失败)', 'status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 6, NULL, NULL, '2019-10-31 23:29:18', 'admin'),
	('f063d973c1ffdb233cc29338ca3d223d', '313704f9a96f4b3dab1686e90dba28ea', 'create_time', '创建日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 3, 'admin', '2019-11-16 23:32:46', '2019-11-13 01:05:45', 'admin'),
	...
	('f4110f83a80f4abef846ca02ce8fad7a', '40289fdc6e226f29016e226f387c0001', 's_measure_model', '测量模式', 's_measure_model', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 12, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	...
	('f47a422604d30f0b654a723c2266eb51', '40289fdc6e226f29016e226f4bbe0003', 'create_date', '创建时间', 'create_date', 0, 0, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 23, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('f52baef18a6faaa6cb9d7f46bb3a555e', '40289fdc6e226f29016e226f5fd20005', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-10-31 23:29:16', 'admin'),
	...
	('f567e606f152a3aaa8d65b68dd9b7ad9', '4028abd16e69f54d016e69f5e8d00004', 's_alarm_speed1', '变形速率报警阈值 - 黄(mm/天)', 's_alarm_speed1', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-11-14 20:49:16', 'admin'),
	('f5b2543c44bb9fa04c41778c66af3363', '40289fdc6e226f29016e226f4bbe0003', 'id', 'ID', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('f5c0c923788a5e6d5e9fc67d98dd800e', '4028abd16e69f54d016e69f54df30000', 'pj_info', '工程简介', 'pj_info', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 14, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('f8c100568a7ffba22f7f99b9458177ab', '40289fdc6e226f29016e226f4bbe0003', 'max_mp', '最大平均误差（单位为mm），当点位平均误差低于该值时，允许保存为基准', 'max_mp', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('f8ecd1eb822124c34c126e3108574dd4', '40289fdc6e226f29016e226f4bbe0003', 'station_status', '0离线，表示通讯中断。1待机/关机，通讯正常，但未启动采集。2正在采集.', 'station_status', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 20, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	('f906b523ff9d2f4ae81c788d5077b5e8', '40289fdc6e608306016e6083061d0000', 'create_time', '创建时间', 'create_time', 0, 1, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 5, 'admin', '2019-11-13 22:02:28', '2019-11-13 00:47:11', 'admin'),
	...
	('fa8de8ae8bb96bb27a1cb6bc62de1650', '40289fdc6e226f29016e226f4bbe0003', 'pressure', '大气参数，气压', 'pressure', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 17, NULL, NULL, '2019-10-31 23:29:11', 'admin'),
	...
	('fa9276657caa55afd3d1193a472a34d7', '40289fdc6e226f29016e226f45580002', 'update_by', '更新者', 'update_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 10, NULL, NULL, '2019-10-31 23:29:08', 'admin'),
	('fab0e9e47aaac909b68c4e73b7681c40', '40289fdc6e226f29016e226f57270004', 'create_by', '创建者', 'create_by', 0, 0, 'string', 64, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 16, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	...
	('fb603e3a00b038ec99f1dfc738edec7f', '4028abd16e69f54d016e69f587010001', 'turnon_lasttime', '上次开机时间', 'turnon_lasttime', 0, 1, 'Date', 0, 0, NULL, NULL, NULL, NULL, 'date', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	('fb6119c4c037a75bf0deccff7dbc5b9b', '40289fdc6e226f29016e226f387c0001', 's_azimuthal_angle', '定向边的坐标方位角', 's_azimuthal_angle', 0, 1, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 35, NULL, NULL, '2019-10-31 23:29:06', 'admin'),
	('fb7da7ad5134e36f5229b5d46c16fefa', '40289fdc6e226f29016e226f57270004', 'id', 'ID', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:13', 'admin'),
	('fc011e1260e8dc80134f1656787a4bec', '4028abd16e69f54d016e69f587010001', 'sort', '排序', 'sort', 0, 1, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 8, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('fcd475ad01902f538a03684bb5097a08', '4028abd16e69f54d016e69f587010001', 'max_mp', '最大平均误差（单位为mm），当点位平均误差低于该值时，允许保存为基准', 'max_mp', 0, 0, 'double', 22, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 13, NULL, NULL, '2019-11-14 20:48:55', 'admin'),
	...
	('fd26554631d9a93fb74efbf83a0c9faa', '40289fdc6e226f29016e226f297f0000', 'id', 'ID', 'id', 1, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 0, 0, 'group', NULL, NULL, 1, NULL, NULL, '2019-10-31 23:29:02', 'admin'),
	...
	('fe4318980d7bb5342fa6af46a23e286d', '4028abd16e69f54d016e69f54df30000', 'remarks', '备注信息', 'remarks', 0, 1, 'string', 255, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 21, NULL, NULL, '2019-11-14 20:48:38', 'admin'),
	...
	('ffabbf9f7cf20184375a49a233cbc222', '40289f8c6e69fee8016e69fee8050000', 'start_period', '数据的起始周期', 'start_period', 0, 0, 'int', 10, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 4, NULL, NULL, '2019-11-14 20:59:05', 'admin'),
	...
	('ffdab5a87819172f6fba2b3b2659a469', '4028abd16e69f54d016e69f5ce020003', 'del_flag', '删除标记', 'del_flag', 0, 0, 'string', 1, 0, NULL, NULL, NULL, NULL, 'text', NULL, 120, NULL, '0', NULL, NULL, 0, 1, 1, 'group', NULL, NULL, 30, NULL, NULL, '2019-11-14 20:49:10', 'admin');
/*!40000 ALTER TABLE `onl_cgform_field` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.onl_cgform_head
...
-- Dumping data for table jeecg-boot.onl_cgform_head: ~2 rows (大约)
...
INSERT INTO `onl_cgform_head` (`id`, `table_name`, `table_type`, `table_version`, `table_txt`, `is_checkbox`, `is_db_synch`, `is_page`, `is_tree`, `id_sequence`, `id_type`, `query_mode`, `relation_type`, `sub_table_str`, `tab_order_num`, `tree_parent_id_field`, `tree_id_field`, `tree_fieldname`, `form_category`, `form_template`, `form_template_mobile`, `scroll`, `copy_version`, `copy_type`, `physic_id`, `update_by`, `update_time`, `create_by`, `create_time`) VALUES
	('313704f9a96f4b3dab1686e90dba28ea', 'agent_config', 1, 14, '代理商配置', 'N', 'Y', 'Y', 'N', NULL, 'UUID', 'single', NULL, '', NULL, NULL, NULL, NULL, 'bdfl_fzbd', '99', NULL, 0, NULL, 0, NULL, 'admin', '2019-11-13 01:06:04', 'admin', '2019-11-13 01:05:45'),
	('40289fdc6e651896016e651896960000', 'cmcc_phone_num', 1, 15, '待选号码', 'Y', 'Y', 'Y', 'N', NULL, 'UUID', 'group', 0, NULL, 1, NULL, NULL, NULL, 'bdfl_ptbd', '99', NULL, 1, NULL, 0, NULL, 'admin', '2019-11-13 22:10:39', 'admin', '2019-11-13 22:09:01');
/*!40000 ALTER TABLE `onl_cgform_head` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.onl_cgform_index
...
-- Dumping data for table jeecg-boot.onl_cgform_index: ~0 rows (大约)
/*!40000 ALTER TABLE `onl_cgform_index` DISABLE KEYS */;
/*!40000 ALTER TABLE `onl_cgform_index` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.oss_file
...
-- Dumping data for table jeecg-boot.oss_file: ~0 rows (大约)
/*!40000 ALTER TABLE `oss_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `oss_file` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_blob_triggers
...
-- Dumping data for table jeecg-boot.qrtz_blob_triggers: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_blob_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_blob_triggers` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_calendars
...
-- Dumping data for table jeecg-boot.qrtz_calendars: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_calendars` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_calendars` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_cron_triggers
...
-- Dumping data for table jeecg-boot.qrtz_cron_triggers: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_cron_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_cron_triggers` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_fired_triggers
...
-- Dumping data for table jeecg-boot.qrtz_fired_triggers: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_fired_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_fired_triggers` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_job_details
...
-- Dumping data for table jeecg-boot.qrtz_job_details: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_job_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_job_details` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_locks
...
-- Dumping data for table jeecg-boot.qrtz_locks: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_locks` DISABLE KEYS */;
INSERT INTO `qrtz_locks` (`SCHED_NAME`, `LOCK_NAME`) VALUES
	('quartzScheduler', 'TRIGGER_ACCESS');
/*!40000 ALTER TABLE `qrtz_locks` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_paused_trigger_grps
...
-- Dumping data for table jeecg-boot.qrtz_paused_trigger_grps: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_paused_trigger_grps` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_paused_trigger_grps` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_scheduler_state
...
-- Dumping data for table jeecg-boot.qrtz_scheduler_state: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_scheduler_state` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_scheduler_state` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_simple_triggers
...
-- Dumping data for table jeecg-boot.qrtz_simple_triggers: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_simple_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_simple_triggers` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_simprop_triggers
...
-- Dumping data for table jeecg-boot.qrtz_simprop_triggers: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_simprop_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_simprop_triggers` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.qrtz_triggers
...
-- Dumping data for table jeecg-boot.qrtz_triggers: ~0 rows (大约)
/*!40000 ALTER TABLE `qrtz_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_triggers` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_announcement
CREATE TABLE IF NOT EXISTS `sys_announcement` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `user_ids` text DEFAULT NULL COMMENT '指定用户',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统通告表';

-- Dumping data for table jeecg-boot.sys_announcement: ~6 rows (大约)
...
-- Dumping structure for table jeecg-boot.sys_announcement_send
...
-- Dumping data for table jeecg-boot.sys_announcement_send: ~2 rows (大约)
...
INSERT INTO `sys_announcement_send` (`id`, `annt_id`, `user_id`, `read_flag`, `read_time`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	...
	('1189613016154628098', '93a9060a1c20e4bf98b3f768a02c2ff9', 'a75d45a015c44384a04449ee80dc3503', '0', NULL, 'jeecg', '2019-10-31 02:40:19', NULL, NULL);
/*!40000 ALTER TABLE `sys_announcement_send` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_category
...
-- Dumping data for table jeecg-boot.sys_category: ~4 rows (大约)
...
-- Dumping structure for table jeecg-boot.sys_data_log
CREATE TABLE IF NOT EXISTS `sys_data_log` (
  ...
  `data_content` text DEFAULT NULL COMMENT '数据内容',
  `data_version` int(11) DEFAULT NULL COMMENT '版本号',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `sindex` (`data_table`,`data_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- Dumping data for table jeecg-boot.sys_data_log: ~17 rows (大约)
...
-- Dumping structure for table jeecg-boot.sys_depart
...
-- Dumping data for table jeecg-boot.sys_depart: ~2 rows (大约)
...
INSERT INTO `sys_depart` (`id`, `parent_id`, `depart_name`, `depart_name_en`, `depart_name_abbr`, `depart_order`, `description`, `org_category`, `org_type`, `org_code`, `mobile`, `fax`, `address`, `memo`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	('6d35e179cd814e3299bd588ea7daed3f', '', '中国移动海南分公司', NULL, NULL, 0, NULL, '1', '1', 'A02', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-26 16:36:39', 'admin', '2019-11-18 01:04:30'),
...
-- Dumping structure for table jeecg-boot.sys_dict
...
-- Dumping data for table jeecg-boot.sys_dict: ~34 rows (大约)
...
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `description`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `type`) VALUES
	...
	('1194604093391491074', '号码状态', 'phone_status', '', 0, 'admin', '2019-11-13 21:13:04', NULL, NULL, 0),
...
-- Dumping structure for table jeecg-boot.sys_dict_item
...
-- Dumping data for table jeecg-boot.sys_dict_item: ~96 rows (大约)
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `item_text`, `item_value`, `description`, `sort_order`, `status`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	...
	('1194604197796106242', '1194604093391491074', '未选', '0', '', 1, 1, 'admin', '2019-11-13 21:13:30', NULL, NULL),
	('1194604239047086081', '1194604093391491074', '已选', '1', '', 1, 1, 'admin', '2019-11-13 21:13:39', NULL, NULL),
...
-- Dumping structure for table jeecg-boot.sys_log
...
-- Dumping data for table jeecg-boot.sys_log: 886 rows
...
INSERT INTO `sys_log` (`id`, `log_type`, `log_content`, `operate_type`, `userid`, `username`, `ip`, `method`, `request_url`, `request_param`, `request_type`, `cost_time`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	...
	('1189612990745534466', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-10-31 02:40:12', NULL, NULL),
	('1189613423811616769', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-10-31 02:41:56', NULL, NULL),
	('1189613462873169921', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-10-31 02:42:06', NULL, NULL),
	('1189923244591013889', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-10-31 23:13:03', NULL, NULL),
	('1189929120571842562', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-10-31 23:36:23', NULL, NULL),
	('1189929183926804481', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-10-31 23:36:39', NULL, NULL),
	('1194292408323555330', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:34:32', NULL, NULL),
	('1194292584379465730', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:35:15', NULL, NULL),
	('1194293352151007233', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:38:18', NULL, NULL),
	('1194293385697050626', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:38:26', NULL, NULL),
	('1194295471700631554', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:46:43', NULL, NULL),
	('1194296697213362178', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:51:35', NULL, NULL),
	('1194296752171327489', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 00:51:49', NULL, NULL),
	('1194571645647458306', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 19:04:08', NULL, NULL),
	('1194571689360494594', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 19:04:19', NULL, NULL),
	('1194575743054712834', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 19:20:25', NULL, NULL),
	('1194575773408890882', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 19:20:33', NULL, NULL),
	('1194576307754840065', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 1144, 'admin', '2019-11-13 19:22:40', NULL, NULL),
	('1194576481176727553', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 19:23:21', NULL, NULL),
	('1194634478112440321', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 23:13:49', NULL, NULL),
	('1194634545779146753', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 23:14:05', NULL, NULL),
	('1194638286573928450', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 23:28:56', NULL, NULL),
	('1194638333176840193', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 23:29:08', NULL, NULL),
	('1194655960720924673', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 00:39:10', NULL, NULL),
	('1194656006669524994', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 00:39:22', NULL, NULL),
	('1194666108206112770', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 01:19:30', NULL, NULL),
	('1194666160827850753', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 01:19:43', NULL, NULL),
	('1194688932484407297', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 02:50:12', NULL, NULL),
	('1194689004198617089', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 02:50:29', NULL, NULL),
	('1194689984944332802', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 02:54:23', NULL, NULL),
	('1194690107778719745', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 02:54:52', NULL, NULL),
	('1194958018011426817', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 20:39:25', NULL, NULL),
	('1194958226552221698', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 20:40:17', NULL, NULL),
	('1194965086831337474', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 21:07:32', NULL, NULL),
	('1194965176207761409', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 21:07:54', NULL, NULL),
	('1194998245924933633', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 23:19:17', NULL, NULL),
	('1194998298747998209', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 23:19:31', NULL, NULL),
	('1195005276446720001', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 23:47:13', NULL, NULL),
	('1195049840767336449', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-15 02:44:19', NULL, NULL),
	('1195049879694671873', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-15 02:44:28', NULL, NULL),
	('1195368302295318529', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-15 23:49:46', NULL, NULL),
	('1195368370456952834', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-15 23:50:03', NULL, NULL),
	('1195378354095898625', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-16 00:29:42', NULL, NULL),
	('1195395037657272321', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-16 01:36:00', NULL, NULL),
	('1195696627966500866', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-16 21:34:25', NULL, NULL),
	('1195696680315609089', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-16 21:34:38', NULL, NULL),
	('1195696776813961217', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-16 21:35:01', NULL, NULL),
	('1195696833462231041', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-16 21:35:14', NULL, NULL),
	('1195697408010575873', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 645, 'admin', '2019-11-16 21:37:31', NULL, NULL),
	('1195697538889637890', 2, '编辑用户，id： a75d45a015c44384a04449ee80dc3503', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-16 21:38:02', NULL, NULL),
	('1195723415581065217', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 1306, 'admin', '2019-11-16 23:20:51', NULL, NULL),
	('1195723465333899265', 2, '编辑用户，id： a75d45a015c44384a04449ee80dc3503', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-16 23:21:04', NULL, NULL),
	('1195773352511508481', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 02:39:17', NULL, NULL),
	('1195773428461965314', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 02:39:36', NULL, NULL),
	('1196062615442538497', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 21:48:43', NULL, NULL),
	('1196062707738198018', 1, '用户名: jeecg,退出成功！', NULL, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 21:49:05', NULL, NULL),
	('1196062775971135489', 1, '用户名: admin,登录成功！', NULL, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 21:49:22', NULL, NULL),
	('1196074504910245890', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 22:35:57', NULL, NULL),
	('1196078415733837825', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 22:51:30', NULL, NULL),
	('1196079794284122113', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 22:56:59', NULL, NULL),
	('1196079840777981953', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-17 22:57:10', NULL, NULL),
	('1196105948059652097', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:40:55', NULL, NULL),
	('1196106006230454273', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:41:09', NULL, NULL),
	('1196107413704658945', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:46:44', NULL, NULL),
	('1196107463415549953', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:46:56', NULL, NULL),
	('1196108124739850241', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 135, 'admin', '2019-11-18 00:49:34', NULL, NULL),
	('1196108819220123650', 2, '编辑用户，id： 1196108679046483970', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 00:52:19', NULL, NULL),
	('1196109532650262530', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 64, 'admin', '2019-11-18 00:55:09', NULL, NULL),
	('1196109555064623105', 2, '编辑用户，id： 1196108679046483970', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 00:55:15', NULL, NULL),
	('1196109594319114241', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:55:24', NULL, NULL),
	('1196109711730266113', 1, '用户名: wangyangsheng,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:55:52', NULL, NULL),
	('1196110258499735553', 1, '用户名: 王杨圣,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 00:58:02', NULL, NULL),
	('1196111240646348801', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 01:01:57', NULL, NULL),
	('1196111631924580354', 1, '用户名: jeecg,退出成功！', NULL, 'jeecg', 'jeecg', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 01:03:30', NULL, NULL),
	('1196111719598116866', 1, '用户名: wangyangsheng,登录成功！', NULL, 'jeecg', 'jeecg', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-18 01:03:51', NULL, NULL),
	('1196111966076391426', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 95, 'admin', '2019-11-18 01:04:50', NULL, NULL),
	('1196112087694430209', 2, '编辑用户，id： f0019fdebedb443c98dcb17d88222c38', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:05:19', NULL, NULL),
	('1196112134070849538', 2, '删除用户，id： 42d153bffeea74f72a9c1697874fa4a7', 3, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:05:30', NULL, NULL),
	('1196112240631336961', 2, '编辑用户，id： a75d45a015c44384a04449ee80dc3503', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:05:55', NULL, NULL),
	('1196112434273964034', 2, '编辑用户，id： a75d45a015c44384a04449ee80dc3503', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:06:41', NULL, NULL),
	('1196112496764899330', 2, '编辑用户，id： 1196108679046483970', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:06:56', NULL, NULL),
	('1196112542885466114', 2, '编辑用户，id： f0019fdebedb443c98dcb17d88222c38', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:07:07', NULL, NULL),
	('1196112584564264961', 2, '编辑用户，id： e9ca23d68d884d4ebb19d07889727dae', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2019-11-18 01:07:17', NULL, NULL),
	('1196113464529244161', 2, '职务表-分页列表查询', 1, 'wangyangsheng', '王杨圣', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 45, 'wangyangsheng', '2019-11-18 01:10:47', NULL, NULL),
	('1196114066747412481', 1, '用户名: 王杨圣,退出成功！', NULL, 'wangyangsheng', '王杨圣', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'wangyangsheng', '2019-11-18 01:13:10', NULL, NULL),
	('1196114096833155073', 1, '用户名: jeecg,登录成功！', NULL, 'wangyangsheng', '王杨圣', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'wangyangsheng', '2019-11-18 01:13:18', NULL, NULL);
/*!40000 ALTER TABLE `sys_log` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_permission
...
-- Dumping data for table jeecg-boot.sys_permission: ~110 rows (大约)
...
INSERT INTO `sys_permission` (`id`, `parent_id`, `name`, `url`, `component`, `component_name`, `redirect`, `menu_type`, `perms`, `perms_type`, `sort_no`, `always_show`, `icon`, `is_route`, `is_leaf`, `keep_alive`, `hidden`, `description`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `rule_flag`, `status`, `internal_or_external`) VALUES
	...
	('1194573409608208385', NULL, '选号中心', '/phone', 'layouts/RouteView', NULL, NULL, 0, NULL, '1', 1.00, 0, 'phone', 1, 0, 0, 0, NULL, 'admin', '2019-11-13 19:11:08', NULL, NULL, 0, 0, '1', 0),
	('1194575305794326530', '1194573409608208385', '公共号码池', '/phone/cmccPhoneNumList', 'phone/CmccPhoneNumList', NULL, NULL, 1, NULL, '1', 1.00, 0, 'global', 1, 0, 0, 0, NULL, 'admin', '2019-11-13 19:18:41', 'admin', '2019-11-16 22:31:28', 0, 0, '1', 0),
	('1194585794549067778', '1194573409608208385', '代理商配置', '/phone/agentConfigList', 'phone/AgentConfigList', NULL, NULL, 1, NULL, '1', 3.00, 0, 'team', 1, 1, 0, 0, NULL, 'admin', '2019-11-13 20:00:22', 'admin', '2019-11-16 22:31:48', 0, 0, '1', 0),
	('1194586245189283842', '1194573409608208385', '我的号码', '/phone/cmccPhoneNumMyList', 'phone/CmccPhoneNumMyList', NULL, NULL, 1, NULL, '1', 2.00, 0, 'table', 1, 0, 0, 0, NULL, 'admin', '2019-11-13 20:02:09', 'admin', '2019-11-16 22:58:10', 0, 0, '1', 0),
	('1195430714583244802', '1194575305794326530', '管理权限', NULL, NULL, NULL, NULL, 2, 'online:cmcc_phone_num:add', '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-16 03:57:46', 'admin', '2019-11-17 00:23:44', 0, 0, '1', 0),
	('1195437034917027841', '1194575305794326530', '选号权限', NULL, NULL, NULL, NULL, 2, 'online:cmcc_phone_num:phone_select', '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-16 04:22:53', 'admin', '2019-11-17 00:36:04', 0, 0, '1', 0),
	('1195705373539135490', '1194575305794326530', '未选号码', '/phone/cmccPhoneNum/list', NULL, NULL, NULL, 2, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-16 22:09:10', 'admin', '2019-11-16 22:52:39', 0, 1, '1', 0),
	('1195705678586671105', '1194586245189283842', '已选号码', '/phone/cmccPhoneNum/my', NULL, NULL, NULL, 2, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-16 22:10:23', 'admin', '2019-11-16 22:58:29', 0, 1, '1', 0),
	('1195737293228564481', '1194586245189283842', '管理权限', NULL, NULL, NULL, NULL, 2, 'online:cmcc_phone_num:add', '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-17 00:16:00', NULL, NULL, 0, 0, '1', 0),
	('1195745365384716290', '1194575305794326530', '显示代理商列', NULL, NULL, NULL, NULL, 2, 'cmccPhoneNum:sysUserCode', '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-17 00:48:05', NULL, NULL, 0, 0, '1', 0),
	...
	('190c2b43bec6a5f7a4194a85db67d96a', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '角色维护', '/isystem/roleUserList', 'system/RoleUserList', NULL, NULL, 1, NULL, NULL, 1.00, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-17 15:13:56', NULL, NULL, 0, 0, NULL, NULL),
	...
	('3f915b2769fc80648e92d04e84ca059d', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '用户管理', '/isystem/user', 'system/UserList', NULL, NULL, 1, NULL, NULL, 1.00, 0, NULL, 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-03-16 11:20:33', 0, 0, NULL, NULL),
	...
	('45c966826eeff4c99b8f8ebfe74511fc', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '部门管理', '/isystem/depart', 'system/DepartList', NULL, NULL, 1, NULL, NULL, 1.00, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-01-29 18:47:40', 'admin', '2019-03-07 19:23:16', 0, 0, NULL, NULL),
	...
	('f0675b52d89100ee88472b6800754a08', '', '统计报表', '/report', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 2.00, 0, 'bar-chart', 1, 0, 0, 0, NULL, 'admin', '2019-04-03 18:32:02', 'admin', '2019-11-16 22:04:57', 0, 0, NULL, 0),
...
-- Dumping structure for table jeecg-boot.sys_permission_data_rule
...
-- Dumping data for table jeecg-boot.sys_permission_data_rule: ~28 rows (大约)
...
INSERT INTO `sys_permission_data_rule` (`id`, `permission_id`, `rule_name`, `rule_column`, `rule_conditions`, `rule_value`, `status`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
	('1194643386709180417', '1194632796108455937', '未选的号码', 'isUse', '=', '0', '1', '2019-11-13 23:49:13', 'admin', '2019-11-14 00:04:58', 'admin'),
	('1195705544842899458', '1195705373539135490', '未选号码', 'isUse', '=', '0', '1', '2019-11-16 22:09:51', 'admin', '2019-11-16 22:53:32', 'admin'),
	('1195705787823124481', '1195705678586671105', '已选号码', 'isUse', '=', '1', '1', '2019-11-16 22:10:49', 'admin', '2019-11-16 22:53:52', 'admin'),
	('1195724180030717953', '1195705678586671105', '我的号码', 'sysUserCode', '=', '#{sys_user_code}', '1', '2019-11-16 23:23:54', 'admin', '2019-11-16 23:39:30', 'admin'),
...
-- Dumping structure for table jeecg-boot.sys_position
...
-- Dumping data for table jeecg-boot.sys_position: ~0 rows (大约)
...
INSERT INTO `sys_position` (`id`, `code`, `name`, `rank`, `company_id`, `create_by`, `create_time`, `update_by`, `update_time`, `sys_org_code`) VALUES
	('1185040064792571906', 'devleader', '研发部经理', '3', NULL, 'admin', '2019-10-18 11:49:03', NULL, NULL, 'A01');
/*!40000 ALTER TABLE `sys_position` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_quartz_job
...
-- Dumping data for table jeecg-boot.sys_quartz_job: 3 rows
...
-- Dumping structure for table jeecg-boot.sys_role
...
-- Dumping data for table jeecg-boot.sys_role: ~5 rows (大约)
/*!40000 ALTER TABLE `sys_role` DISABLE KEYS */;
INSERT INTO `sys_role` (`id`, `role_name`, `role_code`, `description`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	('1195697001221808129', '代理商', 'DLS', NULL, 'admin', '2019-11-16 21:35:54', NULL, NULL),
	('1196108933766565889', '中国移动管理员', 'cmcc-admin', NULL, 'admin', '2019-11-18 00:52:47', NULL, NULL),
...
-- Dumping structure for table jeecg-boot.sys_role_permission
...
-- Dumping data for table jeecg-boot.sys_role_permission: ~397 rows (大约)
...
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`) VALUES
	...
	('1194576252721377282', 'f6817f48af4fb3af11b9e8bf182f618b', '1194573409608208385', NULL),
	('1194576367230070785', 'e51758fa916c881624b046d26bd09230', '1194573409608208385', NULL),
	('1194586448411701249', 'e51758fa916c881624b046d26bd09230', '1194586245189283842', NULL),
	('1194586513503105025', 'f6817f48af4fb3af11b9e8bf182f618b', '1194585794549067778', NULL),
	('1194632890434158593', 'e51758fa916c881624b046d26bd09230', '1194632796108455937', '1194643386709180417'),
	('1194632933367054338', 'f6817f48af4fb3af11b9e8bf182f618b', '1194632634522894337', NULL),
	('1194652746583842818', 'f6817f48af4fb3af11b9e8bf182f618b', '1194575305794326530', NULL),
	('1194652782700994561', 'e51758fa916c881624b046d26bd09230', '1194575305794326530', NULL),
	('1194654083639877633', 'e51758fa916c881624b046d26bd09230', '1194653857965350913', NULL),
	('1194972933262630913', 'f6817f48af4fb3af11b9e8bf182f618b', '1194972275977445377', NULL),
	('1194972933321351169', 'f6817f48af4fb3af11b9e8bf182f618b', '1194972859862310913', NULL),
	('1195440989139066882', 'f6817f48af4fb3af11b9e8bf182f618b', '1195430920775229441', NULL),
	('1195440989352976386', 'f6817f48af4fb3af11b9e8bf182f618b', '1195430714583244802', NULL),
	('1195440989369753601', 'f6817f48af4fb3af11b9e8bf182f618b', '1195438058167820289', NULL),
	('1195440989378142209', 'f6817f48af4fb3af11b9e8bf182f618b', '1195438225289863170', NULL),
	('1195440989558497282', 'f6817f48af4fb3af11b9e8bf182f618b', '1195438322610298881', NULL),
	('1195697285381709826', '1195697001221808129', '1194573409608208385', NULL),
	('1195697285553676290', '1195697001221808129', '1194575305794326530', NULL),
	('1195697285562064897', '1195697001221808129', '1195437034917027841', NULL),
	('1195697285570453505', '1195697001221808129', '1194586245189283842', NULL),
	('1195697289630539778', '1195697001221808129', '1195437034917027841', NULL),
	('1195697289647316994', '1195697001221808129', '1194586245189283842', NULL),
	('1195697289655705601', '1195697001221808129', '1194575305794326530', NULL),
	('1195697289768951810', '1195697001221808129', '1194573409608208385', NULL),
	('1195705914356887553', '1195697001221808129', '1195705373539135490', '1195705544842899458'),
	('1195705914390441986', '1195697001221808129', '1195705678586671105', '1195705787823124481,1195724180030717953'),
	('1195745679399673858', 'f6817f48af4fb3af11b9e8bf182f618b', '1195745365384716290', NULL),
	('1196109483706929154', '1196108933766565889', '1194573409608208385', NULL),
	('1196109483757260802', '1196108933766565889', '1194575305794326530', NULL),
	('1196109483765649409', '1196108933766565889', '1195430714583244802', NULL),
	('1196109483774038017', '1196108933766565889', '1195745365384716290', NULL),
	('1196109483782426625', '1196108933766565889', '1194585794549067778', NULL),
	('1196109483786620930', '1196108933766565889', '3f915b2769fc80648e92d04e84ca059d', NULL),
	('1196109483811786754', '1196108933766565889', '7593c9e3523a17bca83b8d7fe8a34e58', NULL),
	('1196109483820175361', '1196108933766565889', '1a0811914300741f4e11838ff37a1d3a', NULL),
	('1196109483849535490', '1196108933766565889', '700b7f95165c46cc7a78bf227aa8fed3', NULL),
	('1196109483857924097', '1196108933766565889', '8d1ebd663688965f1fd86a2f0ead3416', NULL),
	('1196109483866312706', '1196108933766565889', '024f1fd1283dc632458976463d8984e1', NULL),
	('1196109483887284226', '1196108933766565889', '8b3bff2eee6f1939147f5c68292a1642', NULL),
	('1196109483899867138', '1196108933766565889', 'd07a2c87a451434c99ab06296727ec4f', NULL),
	('1196109483908255745', '1196108933766565889', 'fc810a2267dd183e4ef7c71cc60f4670', NULL),
	('1196109483908255746', '1196108933766565889', '97c8629abc7848eccdb6d77c24bb3ebb', NULL),
	('1196109483916644353', '1196108933766565889', '58857ff846e61794c69208e9d3a85466', NULL),
	('1196109483925032962', '1196108933766565889', '841057b8a1bef8f6b4b20f9a618a7fa6', NULL),
	('1196109483933421570', '1196108933766565889', '08e6b9dc3c04489c8e1ff2ce6f105aa4', NULL),
	('1196109483941810178', '1196108933766565889', 'aedbf679b5773c1f25e9f7b10111da73', NULL),
	('1196109483954393090', '1196108933766565889', '2dbbafa22cda07fa5d169d741b81fe12', NULL),
	('1196109483954393091', '1196108933766565889', 'b1cb0a3fedf7ed0e4653cb5a229837ee', NULL),
	('1196111585481052162', '1196108933766565889', 'd7d6e2e4e2934f2c9385a623fd98c6f3', NULL),
...
-- Dumping structure for table jeecg-boot.sys_sms
CREATE TABLE IF NOT EXISTS `sys_sms` (
  ...
  `es_content` longtext DEFAULT NULL COMMENT '推送内容',
...
-- Dumping data for table jeecg-boot.sys_sms: ~7 rows (大约)
...
-- Dumping structure for table jeecg-boot.sys_sms_template
...
-- Dumping data for table jeecg-boot.sys_sms_template: ~0 rows (大约)
...
-- Dumping structure for table jeecg-boot.sys_user
...
-- Dumping data for table jeecg-boot.sys_user: ~5 rows (大约)
/*!40000 ALTER TABLE `sys_user` DISABLE KEYS */;
INSERT INTO `sys_user` (`id`, `username`, `realname`, `password`, `salt`, `avatar`, `birthday`, `sex`, `email`, `phone`, `org_code`, `status`, `del_flag`, `activiti_sync`, `work_no`, `post`, `telephone`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES
	('1196108679046483970', 'wangyangsheng', '王杨圣', '9c09acd9e843b20ae247671302119358', 'mjbIP9UV', NULL, NULL, NULL, NULL, NULL, 'A02', 1, 0, 1, 'A010', '', NULL, 'admin', '2019-11-18 00:51:46', 'admin', '2019-11-18 01:06:56'),
	('42d153bffeea74f72a9c1697874fa4a7', 'test22', '23232', 'ac52e15671a377cf', '5FMD48RM', 'user/20190314/ly-plate-e_1552531617500.png', '2019-02-09 00:00:00', 1, 'zhangdaiscott@163.com', '18611782222', NULL, 1, 1, 1, NULL, NULL, NULL, 'admin', '2019-01-26 18:01:10', 'admin', '2019-03-23 15:05:50'),
	('a75d45a015c44384a04449ee80dc3503', 'jeecg', 'jeecg', '3dd8371f3cf8240e', 'vDDkDzrK', 'user/20190220/e1fe9925bc315c60addea1b98eb1cb1349547719_1550656892940.jpg', NULL, 2, NULL, NULL, 'A02', 1, 0, 1, 'A001', '', NULL, 'admin', '2019-02-13 16:02:36', 'admin', '2019-11-18 01:06:41'),
	('e9ca23d68d884d4ebb19d07889727dae', 'admin', '管理员', 'cb362cfeefbf3d8d', 'RCGTeGiH', 'user/20190119/logo-2_1547868176839.png', '2018-12-05 00:00:00', 1, '11@qq.com', '18566666661', 'A01', 1, 0, 1, '111', '', NULL, NULL, '2038-06-21 17:54:10', 'jeecg', '2019-11-18 01:07:17'),
	('f0019fdebedb443c98dcb17d88222c38', 'zhagnxiao', '张小红', 'f898134e5e52ae11a2ffb2c3b57a4e90', 'go3jJ4zX', 'user/20190401/20180607175028Fn1Lq7zw_1554118444672.png', '2019-04-01 00:00:00', NULL, NULL, NULL, NULL, 1, 0, 1, 'A002', '', NULL, 'admin', '2023-10-01 19:34:10', 'admin', '2019-11-18 01:07:07');
/*!40000 ALTER TABLE `sys_user` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_user_agent
...
-- Dumping data for table jeecg-boot.sys_user_agent: ~0 rows (大约)
/*!40000 ALTER TABLE `sys_user_agent` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_user_agent` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_user_depart
...
-- Dumping data for table jeecg-boot.sys_user_depart: ~5 rows (大约)
/*!40000 ALTER TABLE `sys_user_depart` DISABLE KEYS */;
INSERT INTO `sys_user_depart` (`ID`, `user_id`, `dep_id`) VALUES
	('1196112497490513922', '1196108679046483970', '6d35e179cd814e3299bd588ea7daed3f'),
	('1196112434651451394', 'a75d45a015c44384a04449ee80dc3503', '6d35e179cd814e3299bd588ea7daed3f'),
	('1f3a0267811327b9eca86b0cc2b956f3', 'bcbe1290783a469a83ae3bd8effe15d4', '5159cde220114246b045e574adceafe9'),
	('1196112585038221313', 'e9ca23d68d884d4ebb19d07889727dae', '6d35e179cd814e3299bd588ea7daed3f'),
	('1196112543246176258', 'f0019fdebedb443c98dcb17d88222c38', '6d35e179cd814e3299bd588ea7daed3f');
/*!40000 ALTER TABLE `sys_user_depart` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.sys_user_role
...
-- Dumping data for table jeecg-boot.sys_user_role: ~16 rows (大约)
/*!40000 ALTER TABLE `sys_user_role` DISABLE KEYS */;
INSERT INTO `sys_user_role` (`id`, `user_id`, `role_id`) VALUES
	('b3ffd9311a1ca296c44e2409b547384f', '01b802058ea94b978a2c96f4807f6b48', '1'),
	('1196112497247244289', '1196108679046483970', '1196108933766565889'),
	...
	('1196112434416570369', 'a75d45a015c44384a04449ee80dc3503', '1195697001221808129'),
	('1196112584769785858', 'e9ca23d68d884d4ebb19d07889727dae', 'f6817f48af4fb3af11b9e8bf182f618b'),
	('1196112543028072449', 'f0019fdebedb443c98dcb17d88222c38', 'ee8626f80f7c2619917b6236f3a7f02b');
/*!40000 ALTER TABLE `sys_user_role` ENABLE KEYS */;

-- Dumping structure for table jeecg-boot.test_demo
...
-- Dumping data for table jeecg-boot.test_demo: ~4 rows (大约)
...
INSERT INTO `test_demo` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `name`, `sex`, `age`, `descc`, `birthday`, `user_code`, `file_kk`, `top_pic`) VALUES
	('4028810c6aed99e1016aed9b31b40002', NULL, NULL, 'admin', '2019-05-29 17:09:25', 'jeecg', '2', 55, '5', '2019-05-15 00:00:00', NULL, NULL, NULL),
...
-- Dumping structure for table jeecg-boot.test_order_main
...
-- Dumping data for table jeecg-boot.test_order_main: ~3 rows (大约)
...
-- Dumping structure for table jeecg-boot.test_order_product
...
-- Dumping data for table jeecg-boot.test_order_product: ~7 rows (大约)
...
-- Dumping structure for table jeecg-boot.test_person
CREATE TABLE IF NOT EXISTS `test_person` (
  ...
  `sex` varchar(32) DEFAULT NULL COMMENT '性别',
  `name` varchar(200) DEFAULT NULL COMMENT '用户名',
  `content` longtext DEFAULT NULL COMMENT '请假原因',
  `be_date` datetime DEFAULT NULL COMMENT '请假时间',
  `qj_days` int(11) DEFAULT NULL COMMENT '请假天数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- Dumping data for table jeecg-boot.test_person: ~0 rows (大约)
